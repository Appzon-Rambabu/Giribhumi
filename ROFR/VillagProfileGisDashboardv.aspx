<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VillagProfileGisDashboardv.aspx.cs" Inherits="ROFR.VillagProfileGisDashboardv" %>
...
<body class="bg-light" onload ="initMap();">
					...
					<div class="col-md-7">
						<div class="collapse navbar-collapse mt-2" id="navbarSupportedContent">
							<ul class="navbar-nav mr-auto">
									...
									<a class="nav-link" href="http://www.giribhumi.ap.gov.in/VillageProfilemapview.aspx">Home <span class="sr-only">(current)</span></a>
								</li>
								<li class="nav-item">
									<a class="nav-link" href="http://www.giribhumi.ap.gov.in/VillagProfileGisDashboardv.aspx">Asset GIS View</a>
								</li>
							 <li class="nav-item">
									<a class="nav-link" href="http://www.giribhumi.ap.gov.in/VillageGisDashboardReport.aspx">Asset MIS Report</a>
								</li>
							</ul>
						</div>
					</div>
									...
									<div class="card-header" id="headingOne">
										<h2 class="mb-0">
											<button class="btn btn-link" type="button" data-toggle="collapse" data-target="#collapseOne"
												...
												MENU <i class="fa fa-caret-square-down float-right"></i>
											</button>
										</h2>
									</div>
    ...
    <footer>
        ...
        <div class="option-panel">
							...
							<div class="accordion" id="accordionExample">
								<div class="card">
									...
									<div class="card-body assets-bar">
                                            <ul class="list-unstyled">
                                                    <li>
														<input class="form-check-input" type="checkbox" id="23" value="option1" onclick="Allassets(23);" checked="checked">
														<label class="form-check-label" for="AllAssets">All Assets</label> 
													</li>
                                                <li>
                                                ...
                                                <div class="sub-assets" id="assetsh">
                                                    <ul>
                                                        <li>
                                                            <input class="form-check-input" type="checkbox" id="Agriculture1h" value="option1">
                                                            <label class="form-check-label" for="Agriculture1">Agriculture1 (1)</label>
                                                            <img src="img/agro.png">
                                                        </li>
                                                        <li>
                                                            <input class="form-check-input" type="checkbox" id="Agriculture2h" value="option1">
                                                            <label class="form-check-label" for="Agriculture2">Agriculture2 (2)</label>
                                                            <img src="img/agro.png">
                                                        </li>
                                                    </ul>
													...
													<li>
														<input class="form-check-input" type="checkbox" id="903" value="option1" onclick="check(903);" checked="checked">
														<label class="form-check-label" for="Diary">Diary</label> <label id="9031"></label> <img src="img/D_Diary.png">
													</li>
													<li>
														<input class="form-check-input" type="checkbox" id="904" value="option1" onclick="check(904);" checked="checked">
														<label class="form-check-label" for="Education">Education</label><label id="9041"></label> <img src="img/D_Education.png">
													</li>
													<li>
														<input class="form-check-input" type="checkbox" id="905" value="option1" onclick="check(905);" checked="checked">
														<label class="form-check-label" for="Electricity">Electricity</label><label id="9051"></label> <img src="img/D_Electricity.png">
													</li>
                                                     <li>
														<input class="form-check-input" type="checkbox" id="906" value="option1" onclick="check(906);" checked="checked">
														<label class="form-check-label" for="Fibernet">Fibernet</label><label id="9061"></label> <img src="img/D_Fibernet.png">
													</li>
                                                    <li>
														<input class="form-check-input" type="checkbox" id="907" value="option1" onclick="check(907);" checked="checked">
														<label class="form-check-label" for="Finance">Finance</label><label id="9071"></label> <img src="img/D_Finance.png">
													</li>
                                                  <li>
														<input class="form-check-input" type="checkbox" id="908" value="option1" onclick="check(908);" checked="checked">
														<label class="form-check-label" for="Food & Civil Supplies">Food & Civil Supplies</label> <label id="9081"></label><img src="img/D_Food & Civil Supplies.png">
													</li>
                                                  <li>
														<input class="form-check-input" type="checkbox" id="909" value="option1" onclick="check(909);" checked="checked">
														<label class="form-check-label" for="Forest">Forest</label><label id="9091"></label> <img src="img/D_Forest.png">
													</li>
                                                   <li>
														<input class="form-check-input" type="checkbox" id="910" value="option1" onclick="check(910);" checked="checked">
														<label class="form-check-label" for="Govt.Hostels">Govt.Hostels</label><label id="9101"></label> <img src="img/D_Govt.Hostels.png">
													</li>
                                                 <li>
														<input class="form-check-input" type="checkbox" id="911" value="option1" onclick="check(911);" checked="checked">
														<label class="form-check-label" for="Health">Health</label><label id="9111"></label> <img src="img/D_Health.png">
													</li>
                                                 <li>
														<input class="form-check-input" type="checkbox" id="912" value="option1" onclick="check(912);" checked="checked">
														<label class="form-check-label" for="Irrigation">Irrigation</label><label id="9121"></label> <img src="img/D_Irrigation.png">
													</li>
                                                  <li>
														<input class="form-check-input" type="checkbox" id="913" value="option1" onclick="check(913);" checked="checked">
														<label class="form-check-label" for="JuvenileWelfare">Juvenile Welfare</label><label id="9131"></label> <img src="img/D_Juvenile Welfare.png">
													</li>
                                                 <li>
														<input class="form-check-input" type="checkbox" id="914" value="option1" onclick="check(914);" checked="checked">
														<label class="form-check-label" for="Miscellaneous">Miscellaneous</label><label id="9141"></label> <img src="img/D_Miscellaneous.png">
													</li>
                                                   <li>
														<input class="form-check-input" type="checkbox" id="915" value="option1" onclick="check(915);" checked="checked">
														<label class="form-check-label" for="PanchayatRaj">Panchayat Raj</label><label id="9151"></label> <img src="img/D_Panchayat Raj.png">
													</li>
                                                 <li>
														<input class="form-check-input" type="checkbox" id="916" value="option1" onclick="check(916);" checked="checked">
														<label class="form-check-label" for="Revenue">Revenue</label> <label id="9161"></label><img src="img/D_Revenue Dept.png">
													</li>
                                                <li>
														<input class="form-check-input" type="checkbox" id="917" value="option1" onclick="check(917);" checked="checked">
														<label class="form-check-label" for="RuralWaterSupply">Rural Water Supply</label><label id="9171"></label> <img src="img/D_Rural Water Supply.png">
													</li>
                                                 <li>
														<input class="form-check-input" type="checkbox" id="918" value="option1" onclick="check(918);" checked="checked">
														<label class="form-check-label" for="SERP">SERP</label><label id="9181"></label> <img src="img/D_SERP.png">
													</li>
                                                 <li>
														<input class="form-check-input" type="checkbox" id="919" value="option1" onclick="check(919);" checked="checked">
														<label class="form-check-label" for="Telecom">Telecom</label><label id="9191"></label> <img src="img/D_Telecom.png">
													</li>
                                                  <li>
														<input class="form-check-input" type="checkbox" id="920" value="option1" onclick="check(920);" checked="checked">
														<label class="form-check-label" for="Veterinary">Veterinary</label> <label id="9201"></label> <img src="img/D_Veterinary.png">
													</li>
                                                 <li>
														<input class="form-check-input" type="checkbox" id="921" value="option1" onclick="check(921);" checked="checked">
														<label class="form-check-label" for="Women & Child welfare">Women & Child welfare</label><label id="9211"></label> <img src="img/D_Women & Child welfare.png">
													</li>
                                                 <li>
														<input class="form-check-input" type="checkbox" id="923" value="option1" onclick="check(923);" checked="checked">
														<label class="form-check-label" for="Skill Development">Skill Development</label><label id="9231"></label> <img src="img/D_Women & Child welfare.png">
													</li>
                                                <li>
														<input class="form-check-input" type="checkbox" id="924" value="option1" onclick="check(924);" checked="checked">
														<label class="form-check-label" for="Skill Development">GCC</label><label id="9241"></label> <img src="img/D_Women & Child welfare.png">
													</li>
                                                    <li>
														<input class="form-check-input" type="checkbox" id="925" value="option1" onclick="check(925);" checked="checked">
														<label class="form-check-label" for="Skill Development">Amusment</label><label id="9251"></label> <img src="img/D_Women & Child welfare.png">
                                                        </li>
                                                    <li>
														<input class="form-check-input" type="checkbox" id="926" value="option1" onclick="check(926);" checked="checked">
														<label class="form-check-label" for="Skill Development">Gas and Petrol</label><label id="9261"></label> <img src="img/D_Women & Child welfare.png">
													</li>
                                                    <li>
														<input class="form-check-input" type="checkbox" id="927" value="option1" onclick="check(927);" checked="checked">
														<label class="form-check-label" for="Skill Development">RTA</label><label id="9271"></label> <img src="img/D_Women & Child welfare.png">
													</li>
                                                    <li>
														<input class="form-check-input" type="checkbox" id="928" value="option1" onclick="check(928);" checked="checked">
														<label class="form-check-label" for="Skill Development">ITDA</label><label id="9281"></label> <img src="img/D_Women & Child welfare.png">
													</li>
                                                    <li>
														<input class="form-check-input" type="checkbox" id="929" value="option1" onclick="check(929);" checked="checked">
														<label class="form-check-label" for="Skill Development">Self Help Group</label><label id="9291"></label> <img src="img/D_Women & Child welfare.png">
													</li>
                                                    <li>
														<input class="form-check-input" type="checkbox" id="930" value="option1" onclick="check(930);" checked="checked">
														<label class="form-check-label" for="Skill Development">Fire Station</label><label id="9301"></label> <img src="img/D_Women & Child welfare.png">
													</li>
                                                    <li>
														<input class="form-check-input" type="checkbox" id="931" value="option1" onclick="check(931);" checked="checked">
														<label class="form-check-label" for="Skill Development">Police Station</label><label id="9311"></label> <img src="img/D_Women & Child welfare.png">
													</li>
                                                    <li>
														<input class="form-check-input" type="checkbox" id="922" value="option1" onclick="check(922);" checked="checked">
														<label class="form-check-label" for="Skill Development">Roads</label><label id="9221"></label> <img src="img/Roadimg.png">
													</li>
            ...
            <div class="setting-button">
                <i class="fa fa-chevron-left icon-before"></i>
                <i class="fa fa-chevron-right icon-after"></i>
            </div>
        </div>
    </footer>
    <!-- Optional JavaScript -->
   ...
   <%--  <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>--%>
    ...
    <script src="js/bootstrap.min.js"></script>
     <script type="text/javascript" src="../MapJsfloder/Dropdownjs1.js"></script>
