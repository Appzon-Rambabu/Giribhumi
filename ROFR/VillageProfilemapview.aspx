<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VillageProfilemapview.aspx.cs" Inherits="ROFR.VillageProfilemapview" %>
...
<body class="bg-light" onload ="initMap();">
				...
				<div class="card m-b-30">
                  ...
                  <div id="map"></div>
                        ...
                        <div class="refresh-btn">
                            <button type="button" class="btn btn-info"  onclick="Referesh()"><i class="fa fa-sync"></i></button>
                        </div>
						<div class="indicators">
							<ul class="list-group list-group-flush">
								<li class=" text-primary"><i class="fa fa-circle text-primary"></i> Districts</li>
								<li class=" text-danger"><i class="fa fa-circle text-danger"></i> Mandals</li>
								<li class=" text-info"><i class="fa fa-circle text-info"></i> Villages</li>
								<li class=" text-warning"><i class="fa fa-circle text-warning"></i> Schools</li>
								<li class=" text-success"><i class="fa fa-circle text-success"></i> Households</li>
							</ul>
						</div>
					</div>
				</div>
    ...
    <script src="linksforcdns/Js/AIzaSyCx2cY6Odt3ckOO-WtYInywqwEhIVSm9L0.js"></script>
     <script type="text/javascript" src="../MapJsfloder/duplicatevillagegismap.js"></script>
