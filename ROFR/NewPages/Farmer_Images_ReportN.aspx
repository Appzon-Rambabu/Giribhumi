<%@ Page Language="C#" MasterPageFile="~/Masters/ROFR_MASTER.Master" AutoEventWireup="true" CodeBehind="Farmer_Images_ReportN.aspx.cs" Inherits="ROFR.NewPages.Farmer_Images_ReportN" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <span id="userprevilages" style="display:none" runat="server"></span>
         ...
         <span id="end" style="display:none" runat="server"></span>
          ...
          <div class="row justify-content-center">
            ...
            <div class="col-md-6">
            <h5 class="text-center text-white rounded py-1 my-0 bg-nav">FARMER IMAGES REPORT</h5>
          </div>
                    ...
                    <div class="maincard-bdy" >
                        ...
                        <table id="dt_dist_tbl" class="table table-striped table-bordered dataTable" >
                            ...
                            <thead class="bg-info text-white">
                              <%-- <tr>
                                   <th colspan="6" style="text-align:center;color: white;">DISTRICT WISE FARMER IMAGES REPORT</th>
                               </tr>--%>
                                <tr>
                                 <th  style="width: 10px!important;">S.NO</th>
                                    ...
                                    <th class="sorting_disabled text-center">IMAGES UPLOADED <br /><span>(4)</span></th>
                                    <th class="sorting_disabled text-center">IMAGES NOT UPLOADED <br /><span>(5)</span></th>
                                </tr>
                            </thead>
                            <tbody>
                    ...
                    <div class="maincard-bdy" >
                        ...
                        <table id="dt_man_tbl" class="table table-striped table-bordered dataTable" >
                            ...
                            <thead class="bg-info text-white">
                               ...
                               <%--<tr>
                                   <th colspan="5" style="text-align:center;color: white;">MANDAL WISE FARMER IMAGES REPORT</th>
                               </tr>--%>
                                <tr>
                                 <th style="text-align:center">S.NO</th>
                                    ...
                                    <th class="sorting_disabled text-center">IMAGES UPLOADED <br /><span>(3)</span></th>
                                    <th class="sorting_disabled text-center">IMAGES NOT UPLOADED <br /><span>(4)</span></th>
                                </tr>
                    ...
                    <div class="maincard-bdy" >
                        ...
                        <table id="dt_Village_tbl" class="table table-striped table-bordered dataTable" >
                            ...
                            <thead class="bg-info text-white">
                               ...
                               <%--<tr>
                                   <th colspan="6" style="text-align:center;color: white;">VILLAGE WISE FARMER IMAGES REPORT</th>
                               </tr>--%>
                                <tr>
                                 <th style="text-align:center">S.NO</th>
                    ...
                    <div class="maincard-bdy" >
                        ...
                        <table id="dt_vil_having_tbl" class="table table-striped table-bordered dataTable" >
                            ...
                            <thead class="bg-info text-white">
                               ...
                               <%--<tr>
                                   <th colspan="12" style="text-align:center;color: white;">VILLAGE WISE IMAGES UPLOADED </th>
                               </tr>--%>
                                <tr>
                                 <th style="text-align:center">S.NO</th>
                                    ...
                                    <th class="sorting_disabled text-center">AADHAAR NO <br /><span>(7)</span></th>
                    ...
                    <div class="maincard-bdy" >
                        ...
                        <table id="dt_man_NotHaving_tbl" class="table table-striped table-bordered dataTable" >
                            ...
                            <thead class="bg-info text-white">
                               ...
                               <%--<tr>
                                   <th colspan="14" style="text-align:center;color: white;">MANDAL WISE  IMAGES NOT UPLOADED</th>
                               </tr>--%>
                                <tr>
                                 <th style="text-align:center">S.NO</th>
                                    <th class="sorting_disabled text-center">BENIFICIARY ID <br /><span>(1)</span></th>
                                    ...
                                    <th class="sorting_disabled text-center">PLOT NO <br /><span>(13)</span></th>
                    ...
                    <div class="maincard-bdy" >
                        ...
                        <table id="dt_vil_not_having_tbl" class="table table-striped table-bordered dataTable" >
                            ...
                            <thead class="bg-info text-white">
                               ...
                               <%--<tr>
                                   <th colspan="12" style="text-align:center;color: white;">VILLAGE WISE IMAGES NOT UPLOADED </th>
                               </tr>--%>
                                <tr>
                                 <th style="text-align:center">S.NO</th>
                                     <th class="sorting_disabled text-center">BENIFICIARY ID <br /><span>(1)</span></th>
                            ...
                            <thead class="bg-info text-white">
                               ...
                               <%--<tr>
								...
								<th style="text-align:center">S.NO</th>
                                    ...
                                    <th style="text-align:center">ITDA_NAME <br /><span>(2)</span></th>
                                    <th style="text-align:center">DISTRICT <br /><span>(3)</span></th>
                                    <th style="text-align:center">MANDAL <br /><span>(4)</span></th>
                                    <th style="text-align:center">GRAM PANCHAYAT <br /><span>(5)</span></th>
                                    <th style="text-align:center">VILLAGE <br /><span>(6)</span>
                                           </th>
                                    <th style="text-align:center">HABITATION <br /><span>(7)</span>
                                     </th>
                                    <th style="text-align:center">ROFR PATTADAAR <br /><span>(8)</span>
                                     </th>
                                    <th style="text-align:center">FATHER NAME <br /><span>(9)</span>
                                     </th>
                                     <th style="text-align:center">COMPARTMENT NO <br /><span>(10)</span>

                                     </th>
                                    <th style="text-align:center">ROFR PATTANO <br /><span>(11)</span>

                                     </th>
                                    <th style="text-align:center">PLOT NO <br /><span>(12)</span>

                                     </th> 
                                   <th style="text-align:center">AADHAAR NO <br /><span>(13)</span>
    ...
    <script src="../NewJsFiles/Farmer_ImagesReportjs.js"></script>
