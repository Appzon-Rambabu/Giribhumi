<%@ Page Language="C#" MasterPageFile="~/Masters/ROFR_MASTER.Master" AutoEventWireup="true" CodeBehind="DistrictData_Analysis.aspx.cs" Inherits="ROFR.NewPages.DistrictData_Analysis" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <span id="userprevilages" style="display:none" runat="server"></span>
         ...
         <span id="end" style="display:none" runat="server"></span>
          ...
          <div class="row justify-content-center">
            ...
            <div class="col-md-6">
            <h5 class="text-center text-white rounded py-1 my-0 bg-nav">DISTRICT MASTER</h5>
          </div>
              <div class="col-md-3 text-right">
                    ...
                    <input type="button" value="Back" id="divisionbackid" class="btn btn-success btn-sm"/>
                   <input type="button" value="Back" id="ForBeatbackid" class="btn btn-success btn-sm"/>
                  <input type="button" value="Back" id="ForRangebackid" class="btn btn-success btn-sm"/>
              </div>
                    ...
                    <div class="maincard-bdy" >
                        ...
                        <table id="dt_dist_tbl" class="table table-striped table-bordered dataTable"  style="width:100%">
                            ...
                            <thead class="bg-info text-white">
                               <%--<tr>
                                   <th colspan="6" style="text-align:center;color: white;">DISTRICT WISE RYTHU BHAROSA PAYMENT STATUS OCT-20</th>
                               </tr>--%>
                                <tr>
                                <th>S.NO</th>
                    ...
                    <div class="maincard-bdy" >
                        ...
                        <table id="dt_mandal_tbl" class="table table-striped table-bordered dataTable"  style="width:100%">
                            ...
                            <thead class="bg-info text-white">
                               ...
                               <tr>
                                   <th colspan="9" style="text-align:center;color: white;">MANDAL WISE MASTER DATA</th>
                               </tr>
                                <tr>
                                <th>S.NO</th>
                                    <th>LGD DISTRICT CODE</th>
         ...
         <div class="row justify-content-center">
                 <div class="col-md-10">
                    ...
                    <div class="maincard-bdy" >
                        ...
                        <table id="dt_division_tbl" class="table table-striped table-bordered dataTable"  style="width:100%">

                            <thead class="bg-info text-white">
                                 
                               <tr>
                                   <th colspan="7" style="text-align:center;color: white;">FOREST DIVISION MASTER</th>
                               </tr>
                                <tr>
                                <th>S.NO</th>
                                    <th>LGD DISTRICT CODE</th>
                    ...
                    <div class="maincard-bdy" >
                        ...
                        <table id="dt_village_tbl" class="table table-striped table-bordered dataTable"  style="width:100%">
                            ...
                            <thead class="bg-info text-white">
                               ...
                               <tr>
                                   <th colspan="12" style="text-align:center;color: white;">VILLAGE MASTER</th>
                               </tr>
                                <tr>
                                <th>S.NO</th>
                                   <th>LGD DISTRICT CODE</th>
         ...
         <div class="row justify-content-center">
                 <div class="col-md-12">
                    ...
                    <div class="maincard-bdy" >
                        ...
                        <table id="dt_range_tbl" class="table table-striped table-bordered dataTable"  style="width:100%">

                            <thead class="bg-info text-white">
                                  
                               <tr>
                                   <th colspan="12" style="text-align:center;color: white;">FOREST RANGE MASTER</th>
                               </tr>
                                <tr>
                                <th>S.NO</th>
                                   <th>LGD DISTRICT CODE</th>
         ...
         <div class="row justify-content-center">
                 <div class="col-md-12">
                    ...
                    <div class="maincard-bdy" >
                        ...
                        <table id="dt_beat_tbl" class="table table-striped table-bordered dataTable"  style="width:100%">

                            <thead class="bg-info text-white">
                                  
                               <tr>
                                   <th colspan="17" style="text-align:center;color: white;">FOREST BEAT MASTER</th>
                               </tr>
                                <tr>
                                <th>S.NO</th>
                                   <th>LGD DISTRICT CODE</th>
        ...
        <div class="row justify-content-center">
                 <div class="col-md-12">
                    ...
                    <div class="maincard-bdy" >
                        ...
                        <table id="dt_Rbeat_tbl" class="table table-striped table-bordered dataTable"  style="width:100%">
        ...
        <div class="row justify-content-center">
                 <div class="col-md-12">
                    ...
                    <div class="maincard-bdy" >
                        ...
                        <table id="dt_ForestRanges_tbl" class="table table-striped table-bordered dataTable"  style="width:100%">
    ...
    <script src="../NewJsFiles/DistrictData_Analysis.js"></script>
    <%--<script src="../NewJsFiles/RythubarosaPayment_Oct20.js"></script>--%>
     <script src="../Newcdn/tabletoexcel.js"></script>
    <script src="https://kit.fontawesome.com/86b1980384.js" crossorigin="anonymous"></script>
</asp:Content>