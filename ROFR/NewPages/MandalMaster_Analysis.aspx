<%@ Page Language="C#"  MasterPageFile="~/Masters/ROFR_MASTER.Master" AutoEventWireup="true" CodeBehind="MandalMaster_Analysis.aspx.cs" Inherits="ROFR.NewPages.MandalMaster_Analysis" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <span id="userprevilages" style="display:none" runat="server"></span>
         ...
         <span id="end" style="display:none" runat="server"></span>
          ...
          <div class="row justify-content-center">
            ...
            <div class="col-md-6">
            <h5 class="text-center text-white rounded py-1 my-0 bg-nav">MANDAL MASTER</h5>
          </div>
              <div class="col-md-3 text-right">
                  ...
                  <input type="button" value="Back" id="Frangebackid" class="btn btn-success btn-sm"/>
    ...
    <script src="../NewJsFiles/MandalMaster_Analysis.js"></script>
