<%@ Page Language="C#" MasterPageFile="~/Masters/ROFR_MASTER.Master" AutoEventWireup="true" CodeBehind="Beneficiary_Master_analysis.aspx.cs" Inherits="ROFR.NewPages.Beneficiary_Master_analysis" EnableEventValidation="false"  %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <span id="userprevilages" style="display:none" runat="server"></span>
         ...
         <span id="end" style="display:none" runat="server"></span>
          ...
          <div class="row justify-content-center">
            ...
            <div class="col-md-6">
            <h5 class="text-center text-white rounded py-1 my-0 bg-nav">BENEFICIARY MASTER</h5>
          </div>
         ...
         <div class="row justify-content-center">
                 <div class="col-md-6">
                    ...
                    <div class="maincard-bdy" >
                        ...
                        <table id="dt_ben_Details_tbl" class="table table-striped table-bordered dataTable"  style="width:100%">
                            <thead class="bg-info text-white">
                               <tr>
    ...
    <script src="../NewJsFiles/BenificiaryMaster_Analysis.js"></script>
