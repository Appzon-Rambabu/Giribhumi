<%@ Page Language="C#" MasterPageFile="~/Masters/ROFR_MASTER.Master" AutoEventWireup="true" CodeBehind="ForestRange_Master_Analysis.aspx.cs" Inherits="ROFR.NewPages.ForestRange_Master_Analysis" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <span id="userprevilages" style="display:none" runat="server"></span>
         ...
         <span id="end" style="display:none" runat="server"></span>
          ...
          <div class="row justify-content-center">
            ...
            <div class="col-md-6">
            <h5 class="text-center text-white rounded py-1 my-0 bg-nav">FOREST RANGE MASTER</h5>
          </div>
         ...
         <div class="row justify-content-center">
                 <div class="col-md-12">
                    ...
                    <div class="maincard-bdy" >
                        ...
                        <table id="dt_ForestBeat_tbl" class="table table-striped table-bordered dataTable"  style="width:100%">
    ...
    <script src="../NewJsFiles/ForestRange_Master_Analysis.js"></script>
