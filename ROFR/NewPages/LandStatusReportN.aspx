<%@ Page Language="C#" MasterPageFile="~/Masters/ROFR_MASTER.Master" AutoEventWireup="true" CodeBehind="LandStatusReportN.aspx.cs" Inherits="ROFR.NewPages.LandStatusReportN" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <span id="userprevilages" style="display:none" runat="server"></span>
         ...
         <span id="end" style="display:none" runat="server"></span>
          ...
          <div class="row justify-content-center">
            ...
            <div class="col-md-6">
            <h5 class="text-center text-white rounded py-1 my-0 bg-nav">Phase-II Plot Wise Land Status Report</h5>
          </div>
   ...
   <script src="../NewJsFiles/LandStatusReportN.js"></script>
