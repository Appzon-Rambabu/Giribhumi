<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VillageReport.aspx.cs" Inherits="ROFR.VillageReport" %>
            ...
            <ItemTemplate>
                 ...
                 <asp:Label ID="lbl7" Font-Bold="True" Text='<%# Eval("SUB_ASSET_IMG3") %>' runat="server" />
                       ...
                       --%>
                         ...
                         <asp:BoundField ItemStyle-Width="150px" DataField="SUBASSET_NAME" HeaderText="SUBASSET_NAME"/>
        <asp:BoundField ItemStyle-Width="150px" DataField="SUBASSET_STATUS" HeaderText="SUBASSET_STATUS"/>
        <asp:BoundField ItemStyle-Width="150px" DataField="SUBASSET_CONDITION" HeaderText="SUBASSET_CONDITION"/>
                         <asp:BoundField ItemStyle-Width="150px" DataField="SUB_ASSET_IMG1" HeaderText="SUB_ASSET_IMG1"/>
        <asp:BoundField ItemStyle-Width="150px" DataField="SUB_ASSET_IMG2" HeaderText="SUB_ASSET_IMG2"/>
        <asp:BoundField ItemStyle-Width="150px" DataField="SUB_ASSET_IMG3" HeaderText="SUB_ASSET_IMG3"/>
                    </Columns>  
                    <FooterStyle BackColor="#99CCCC" ForeColor="#003399" />  
                    <HeaderStyle BackColor="#003399" Font-Bold="True" ForeColor="#CCCCFF" />  
                    <PagerStyle BackColor="#99CCCC" ForeColor="#003399" HorizontalAlign="Left" />  
