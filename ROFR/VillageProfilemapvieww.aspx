<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VillageProfilemapvieww.aspx.cs" Inherits="ROFR.VillageProfilemapvieww" %>
...
<body  onload ="initMap();">
    ...
    <main>
        ...
        <button data-toggle-active=".mobile-menu"
            class="mobile-menu-toggle mobile-menu-toggle--tablet visible-sm visible-md">
            <span class="fa fa-bars"></span>
        </button>
        <!-- mobile-header -->
        <header class="mobile-header visible-xs">
            <button data-toggle-active=".mobile-menu"
                class="mobile-menu-toggle mobile-header__btn active pull-left"><span class="fa fa-bars"></span></button>
        ...
        <div class="sidebar container container--sidebar pull-right full-height" data-offset="0">
            ...
            <section class="overview sidebar__item" data-offset="0">
                ...
                <header class="overview__header overview-header overview-block ">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Illitarate &gt; 6%</li>
                    </ol>
            ...
            <nav class="menu sidebar__item visible-lg" data-offset="0">
                <header>
                    <h4 class="places-block__title">Indicators:</h4>
                </header>
                <a href="#!" class="menu-item menu-item-active active">
                    <i class="menu-item__icon fa fa-circle"></i> <span class="menu-item__title">LITERACY AMONG CHILDREN
                        AGED 6 TO 15 YEARS 80.39%</span> <span class="arrow-tgl" title="Report" data-overview-toggle><i
                ...
                <a href="" class="menu-item menu-item-active">
                    <i class="menu-item__icon fa fa-circle"></i> <span class="menu-item__title">Illitarate &lt;
                        3%</span>
                </a>

                <ul style="width: 100%;display: initial;">
                    <li class="menu-item menu-item-active">
                        <i class="menu-item__icon fa fa-circle"></i> <span class="menu-item__title">Illitarate &gt;
                            6%</span>
                        <span class="arrow-tgl" title="Report" data-overview-toggle><i
                                class="fa fa-angle-double-right"></i></span>
                    </li>
                </ul>
                ...
                <!-- collapse-block -->
                <section class="collapse-block overview-block overview-block--fluid"
                    style="position: fixed; width: 100%;bottom: 0;">
                    <div data-toggle="collapse" data-target="#wikipedia-description"
                        class="collapse-header collapse-header--wiki">
                        <p>Advance Search</p>
                        <button class="collapse-header__arrow fa fa-angle-down"></button>
                    </div>
                    <div class="collapse collapse-content" id="wikipedia-description">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <div class="checkbox checkbox-success">
                                            ...
                                            <label for="checkbox1"> Option </label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <div class="checkbox checkbox-success">
                                            ...
                                            <label for="checkbox2"> Option </label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <div class="checkbox checkbox-success">
                                            ...
                                            <label for="checkbox3"> Option </label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <div class="checkbox checkbox-success">
                                            ...
                                            <label for="checkbox4"> Option </label>
                                        </div>
                                    </div>
                                </div>
...
8	Srisailam<br>
            ...
            <div class="modal-body">
                <div class="row">
                        ...
                        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner" role="listbox">
                                <div class="item active" id="imgh1">
                                    <a href="#" id="abc1" data-rel="instagram"
                                       class="lightbox instagram__item">
                                        <img id="img1" src="" alt="" />
                                    </a>

                                </div>
                                <div class="item" id="imgh2">
                                    <a href="#" id="abc2" data-rel="instagram"
                                       class="lightbox instagram__item">
                                        <img id="img2" src="" alt="" />
                                    </a>
                                ...
                                <div class="item" id="imgh3">
                                    <a href="#" id="abc3" data-rel="instagram"
                                       class="lightbox instagram__item">
                                        <img id="img3" src="" alt="" />
                                    </a>
                                </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card mb-3">
                            <div class="card-body">
                                <div id="AssetDetails" style="max-height: 245px;overflow-y:scroll;">
                                    <div class="col-md-12">
                                        <table class="table table-condensed">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>Facilities</td>
                                                    <td><select class="form-control" id="facility">
                                        ...
                                        <table class="table table-condensed">
                                            <tbody>
                                                <tr>
                                                    <td width="50%">ROAD NAME</td width="50%">
                                                    <td>--</td>
                                                </tr>
                                                <tr>
                                                    <td>ROAD CATEGORY</td>
                                                ...
                                                <tr>
                                                    <td>ROAD CONNECTING FROM</td>
                                                    <td>--</td>
                                                </tr>
                                                <tr>
                                                    <td>ROAD CONNECTING TO</td>
                                                    <td>--</td>
                                                </tr>
                                                <tr>
                                                    <td>ROAD CONNECTION NAME</td>
                                                    <td>--</td>
                                                </tr>
                                                <tr>
                                        ...
                                        <!-- <div class="row mb-1 border-bottom">
                                            ...
                                            <div class="col-md-6"><label id="DEP" for="road-name" class="text-success">assd </label></div>
                                        </div>
                                        <div class="row mb-1">
                                            <div class="col-md-6"><label for="road-name"> ASSET NAME </label></div>
                                            <div class="col-md-6">
                                                <label id="ASSET" for="road-name" class="text-success"> dsfsdf </label>
                                            </div>
                                        </div>
                                        <div class="row mb-1">
                                            <div class="col-md-6"><label for="road-name"> SUBASSET NAME </label></div>
                                            <div class="col-md-6">
                                                <label id="SUBASSET" for="road-name" class="text-success">sdfsd </label>
                                            </div>
                                        </div>
                                        <div class="row mb-1">
                                            <div class="col-md-6"><label for="road-name"> CONDITION </label></div>
                                            <div class="col-md-6">
                                                <label id="Con" for="road-name" class="text-success"> </label>
                                            </div>
                                        </div>
                                        <div class="row mb-1">
                                ...
                                <!-- <div id="RoadDetails">
                                    <div class="col-md-12">
                                        ...
                                        <div class="row mb-1">
                                            ...
                                            <div class="col-md-6">
                                                <label id="RC" for="road-name" class="text-success">  </label>
                                            </div>
                                        </div>
                                        <div class="row mb-1">
                                            <div class="col-md-6"><label for="road-name"> ROAD LENGTH </label></div>
                                            <div class="col-md-6">
                                                <label id="RL" for="road-name" class="text-success"> </label>
                                        ...
                                        <div class="row mb-1">
                                            ...
                                            <div class="col-md-6">
                                                <label id="RT" for="road-name" class="text-success"> </label>
                                            </div>
                                        </div>
                                        <div class="row mb-1">
                                            <div class="col-md-6"><label for="road-name"> ROAD CONNECTING FROM </label></div>
                                            <div class="col-md-6">
                                                <label id="RCF" for="road-name" class="text-success"> </label>
                                            </div>
                                        </div>
                                        <div class="row mb-1">
                                            <div class="col-md-6"><label for="road-name"> ROAD CONNECTING TO </label></div>
                                            <div class="col-md-6">
                                                <label id="RCT" for="road-name" class="text-success"> </label>
                                            </div>
                                        </div>
                                        <div class="row mb-1">
                                            <div class="col-md-6"><label for="road-name"> ROAD CONNECTION NAME </label></div>
                                            <div class="col-md-6">
                                                <label id="RCN" for="road-name" class="text-success"> </label>
                                            </div>
                                        </div>
                                        <div class="row mb-1">
                                            <div class="col-md-6"><label for="road-name"> ROAD CONDITION </label></div>
                                            <div class="col-md-6">
                                                <label id="RCC" for="road-name" class="text-success"> </label>
                                            </div>
                                        </div>
                                        <div class="row mb-1">
                                            <div class="col-md-6"><label for="road-name"> DEPARTMENT </label></div>
                                            <div class="col-md-6">
                                                <label id="DEPA" for="road-name" class="text-success"> </label>
                                            </div>
                                        </div>
                                        <div class="row mb-1">
                                            <div class="col-md-6"><label for="road-name"> ROAD TRANSPORT TYPE </label></div>
                                            <div class="col-md-6">
                                                <label id="RTT" for="road-name" class="text-success"> </label>
                                            </div>
                                        </div>
                                    </div>
                                </div> -->
    ...
    <script type="text/javascript" src="GISNew/js/myworld/map-init--index.js"></script>
     <script type="text/javascript" src="../MapJsfloder/duplicatevillagegismap1.js"></script>
