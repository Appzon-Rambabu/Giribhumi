            ...
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    if (((string)(Session["username"]) != null))
                    {
                        ...
                        if ((string)(Session["masterusername"]) == "master_admin" || (string)(Session["masterusername"]) == "Hod_admin" || (string)(Session["masterusername"]) == "prisec_tw"|| (string)(Session["masterusername"]) == "TW_PRLSECRETARY" || (string)(Session["masterusername"]) == "TW_DIRECTOR" || (string)(Session["masterusername"]) == "ROFR_TEST")
                        {
                            dt = ud.checkGetUserId((string)(Session["masterusername"]));
                        }
                        else
                        {
                             dt = ud.checkGetUserId((string)(Session["username"]));
                        }
                        if (dt.Rows.Count> 0)
                        {
                            if (dt.Rows[0]["Login_status"].ToString() == "0")
                            {
                                //Response.Redirect("Login.aspx");
                                //demo purpose
                                //if ((string)(Session["username"]) == "PO_CHINTUR"||(string)(Session["username"]) == "admin" || (string)(Session["username"]) == "master_admin" || (string)(Session["username"]) == "Hod_admin"||(string)(Session["username"]) == "ITDA_DIRECTOR"|| (string)(Session["username"]) == "prisec_tw")
                                //{
                                //    //Response.Redirect("Login.aspx");
                                //}
                                //else
                    ...
                    if (((string)(Session["username"]) != null))
                    {
                        ...
                        //else if(user == "TW_DIRECTOR" || user == "TW_PRLSECRETARY")
                        //{
                    ...
                    txt_admin.Text = "Welcome To " +((string)Session["masterusername"]);

                    // ================== GSR MENU ==================Rbabu15072026
                    string privilege = Convert.ToString(Session["userprevilages"]);
