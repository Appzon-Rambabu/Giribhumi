<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ROFR_MASTER.Master" AutoEventWireup="true" CodeBehind="CurdForestRange.aspx.cs" Inherits="ROFR.pages.CurdForestRange" EnableEventValidation="false" %>
      ...
      onrowcommand="gridView_RowCommand"
        OnRowDataBound="gridView_RowDataBound">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="FOREST RANGE CODE" ItemStyle-Width="190">
                                            <ItemTemplate>
                                                <asp:Label ID="lbl_divisioncode" runat="server" Text='<%# Eval("FOREST_RANGE_CODE") %>'></asp:Label>
                                        ...
                                        <asp:TemplateField HeaderText="FOREST RANGE NAME" ItemStyle-Width="250">
                                            <ItemTemplate>
                                                <asp:Label ID="lbl_division" runat="server" Text='<%# Eval("FOREST_RANGE_NAME") %>'></asp:Label>
                                ...
                                <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="FOREST RANGE NAME" ItemStyle-Width="190">
                                            <ItemTemplate>
                                                <asp:Label ID="lbl_division" runat="server" Text='<%# Eval("FOREST_RANGE_NAME") %>'></asp:Label>
