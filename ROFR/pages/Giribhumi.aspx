<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Giribhumi.aspx.cs" Inherits="ROFR.pages.Giribhumi" %>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="../pages/Details_1B.aspx">Mee 1-B</a></li>
                            <li><a class="dropdown-item" href="../pages/Grama1B.aspx">Grama 1-B</a></li>
                        </ul>
                    </li>
                    <%--                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true"
                ...
                <li class="nav-item"><a class="nav-link" href="">డిపార్టుమెంటు లాగిన్</a></li>--%>
                     <li class="nav-item"><a class="nav-link" href="../pages/Epassbook.aspx">Epassbook</a></li>
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true"
                            aria-expanded="false">Reports</a>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="../pages/ItdawiseLandDetails.aspx">Land Summary Report</a></li>
                            <li><a class="dropdown-item" href="../pages/ITDAWISE_POPULATION_REPORT.aspx">Population Report</a></li>
