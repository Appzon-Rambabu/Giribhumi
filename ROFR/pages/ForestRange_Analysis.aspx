<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ROFR_MASTER.Master" AutoEventWireup="true" CodeBehind="ForestRange_Analysis.aspx.cs" Inherits="ROFR.pages.ForestRange_Analysis" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel panel-body"> 
	 ...
	 <div class="row mb-1 mt-1 justify-content-end">
               ...
               <div class="col-md-4"> 
                   <h5 class="text-center text-success mb-1 mt-1 thick" id="Title_Header">FOREST RANGE MASTER</h5>
               </div>
 ...
 <ItemTemplate>
                <div style="text-align:right">
              <asp:Label  ID="lbl7" runat="server"  Font-Bold="True" Text='<%# Eval("FOREST_DIVISION_CODE") %>'></asp:Label>
                    </div>
            </ItemTemplate>
        </asp:TemplateField> 
 ...
 <ItemTemplate>
                <div style="text-align:left">
              <asp:Label  ID="lbl8" runat="server"  Font-Bold="True" Text='<%# Eval("FOREST_DIVISION_NAME") %>'></asp:Label>
                    </div>
            </ItemTemplate>
        </asp:TemplateField> 
 ...
 <ItemTemplate>
                <div style="text-align:right">
              <asp:Label  ID="lbl9" runat="server"  Font-Bold="True" Text='<%# Eval("FOREST_RANGE_CODE") %>'></asp:Label>
                    </div>
            </ItemTemplate>
        </asp:TemplateField> 
 ...
 <ItemTemplate>
                <div style="text-align:left">
              <asp:Label  ID="lbl10" runat="server"  Font-Bold="True" Text='<%# Eval("FOREST_RANGE_NAME") %>'></asp:Label>
                    </div>
            </ItemTemplate>
        </asp:TemplateField> 
            ...
            <ItemTemplate>
                <asp:Label ID="lbl11" ForeColor="Red"  Font-Bold="True" Text='<%# Eval("NO_OF_BEATS") %>' runat="server" />
  <asp:LinkButton ID="LinkButton11" runat="server" Font-Bold="True" ForeColor="Red" Font-Underline="True"  CommandName="MyUpdate" CommandArgument='<%#Eval("LGD_DISTRICT_CODE")+"-"+Eval("LGD_MANDAL_CODE")+"&"+Eval("FOREST_DIVISION_CODE")+"#"+Eval("FOREST_RANGE_CODE")+","+ "11"%>' CausesValidation="false"  Visible ="false"  OnClick="link_onclick" ><%# Eval("NO_OF_BEATS") %></asp:LinkButton>
            </ItemTemplate>
        </asp:TemplateField>   
                    </Columns>  
