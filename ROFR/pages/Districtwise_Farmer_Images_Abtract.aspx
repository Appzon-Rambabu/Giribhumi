<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ROFR_MASTER.Master" AutoEventWireup="true" CodeBehind="Districtwise_Farmer_Images_Abtract.aspx.cs" Inherits="ROFR.pages.Districtwise_Farmer_Images_Abtract"  EnableEventValidation="false"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      <div class="panel panel-body" style="margin-top:150px;"> 
         ...
         <div class="row mb-1 mt-1 justify-content-end">
               ...
               <div class="col-md-4"> <h5 class="text-center text-success mb-1 mt-1">DISTRICT WISE FARMER IMAGES REPORT</h5></div>
            <div class="col-md-4">
    ...
    <div class="row justify-content-center" style="text-align:right">
      ...
      <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"   
            ...
            <ItemTemplate>
                <asp:Label ID="lbl4" ForeColor="Black" Font-Bold="True" Text='<%# Eval("Images_Uploaded") %>' runat="server" />
            ...
            <ItemTemplate>
                 <asp:Label ID="lbl6" ForeColor="Red" Font-Bold="True" Text='<%# Eval("Images_Not_Uploaded") %>' runat="server" />
            ...
            <ItemTemplate>
                <asp:Label ID="lbl7" ForeColor="Black" Font-Bold="True" Text='<%# Eval("Aadhaar_Service_Image_Uploaded") %>' runat="server" />
            ...
            <ItemTemplate>
                 <asp:Label ID="lbl8" ForeColor="Red" Font-Bold="True" Text='<%# Eval("Aadhaar_Service_Image_not_Uploaded") %>' runat="server" />
         
            </ItemTemplate>
        </asp:TemplateField>
                         <%-- <asp:TemplateField HeaderText="FARMER NAME MATCHED WITH AADHAR NAME" ItemStyle-Width = "150" HeaderStyle-ForeColor="White" HeaderStyle-CssClass="header-center">
            <ItemTemplate>
                <asp:Label ID="lbl4" ForeColor="Black" Font-Bold="True" Text='<%# Eval("Images_Uploaded") %>' runat="server" />
                         ...
                         <asp:TemplateField HeaderText="FARMER NAME NOT MATCHED WITH AADHAR NAME" ItemStyle-Width = "150" HeaderStyle-ForeColor="White" HeaderStyle-CssClass="header-center">
            <ItemTemplate>
                 <asp:Label ID="lbl6" ForeColor="Red" Font-Bold="True" Text='<%# Eval("Images_Not_Uploaded") %>' runat="server" />
