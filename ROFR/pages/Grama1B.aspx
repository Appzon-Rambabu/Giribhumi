<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Adangal.master" AutoEventWireup="true" CodeBehind="Grama1B.aspx.cs" Inherits="ROFR.pages.Grama1B"  EnableEventValidation="false"%>
                        ...
                        <body>
                         ...
                         <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-md-6">
                                        <h5 class="text-center text-white rounded py-1 bg-nav">GRAMA 1B NAMUNA</h5>
                    ...
                    <ContentTemplate>
                        <div>
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-md-4 text-left">
                                                <%--<div class="form-group">--%>
                                                 <input type="text" id="txtInput" maxlength="5" name="captcha" class="form-control" autocomplete="off" runat="server" onkeypress="codevalidate(event)"/>
                                                <%--</div>--%>
                                            </div>
                                        </div>
