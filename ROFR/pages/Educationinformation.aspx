<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Giripragathi.Master" AutoEventWireup="true" CodeBehind="Educationinformation.aspx.cs" Inherits="ROFR.pages.Educationinformation" EnableEventValidation="false"  %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="panel panel-body" style="margin-top:150px;">
        <h5 class="text-center text-success mb-4">EDUCATION INFORMATION</h5>
