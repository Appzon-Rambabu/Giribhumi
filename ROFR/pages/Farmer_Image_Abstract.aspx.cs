...
{
    public partial class Farmer_Image_Abstract : System.Web.UI.Page
    {
        ...
        protected void BindData()
        {
            try
            {
                ...
                DataTable dt = ProjectRofrBAL.GetMasterDetails.GetFarmerImagesReport("FDistrict", "", "", "", "", (string)(Session["username"]), (string)Session["userprevilages"]);
        ...
        protected void link_onclick(object sender, EventArgs e)
        {
            try
            {
                ...
                DataTable dt = ProjectRofrBAL.GetMasterDetails.GetFarmerImagesReport("FMandal", (string)(Session["Itda"]), (string)(Session["District"]), "", "", (string)(Session["username"]), (string)Session["userprevilages"]);

                Session["inputtype"] = "FMandal";
                if (dt.Rows.Count > 0)
                {
                    ...
                    Session["exceldata_type"] = (string)(Session["District"]);
        ...
        protected void Mandal_onclick(object sender, EventArgs e)
        {
            try
            {
                ...
                DataTable dt = ProjectRofrBAL.GetMasterDetails.GetFarmerImagesReport("FVillage", (string)(Session["Itda"]), (string)(Session["District"]), (string)(Session["Mandal"]), "", (string)(Session["username"]), (string)Session["userprevilages"]);
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    GridView3.DataBind();
                    Session["exceldata"] = dt;
                    Session["inputtype"] = "FVillage";
                    Session["exceldata_type"] = lbl_mandal.Text;
                    Farmer_image_not_excel.Visible = true;
                    for (int i = 0; i <= dt.Rows.Count - 1; i++)
                    {
                        for (int j = 0; j <= dt.Columns.Count - 1; j++)
        ...
        protected void mandclick_Farmer_image_not_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Farmer_image_not_excel.Visible = true;
                dt = ProjectRofrBAL.GetMasterDetails.GetFarmerImagesReport(end, (string)(Session["Itda"]), (string)(Session["District"]), (string)(Session["Mandal"]), (string)(Session["Village"]), (string)(Session["username"]), (string)Session["userprevilages"]);
        ...
        protected void Rejected_onclick(object sender, EventArgs e)
        {
            try
            {
                ...
                if (end == "HAVING")
                {
                    ...
                    btn_img_notupload.Visible = false; Farmer_image_not_excel.Visible = false;
                    dt = ProjectRofrBAL.GetMasterDetails.GetFarmerImagesReport("Having", (string)(Session["Itda"]), (string)(Session["District"]), (string)(Session["Mandal"]), (string)(Session["Village"]), (string)(Session["username"]), (string)Session["userprevilages"]);
                    txtstatus = "IMAGES UPLOADED";
                }
                if (end == "NOTHAVING")
                {
                    btn_img_upload.Visible = false;
                    btn_img_notupload.Visible = true; Farmer_image_not_excel.Visible = false;
                    dt = ProjectRofrBAL.GetMasterDetails.GetFarmerImagesReport("Nothaving", (string)(Session["Itda"]), (string)(Session["District"]), (string)(Session["Mandal"]), (string)(Session["Village"]), (string)(Session["username"]), (string)Session["userprevilages"]);
                    txtstatus = "IMAGES NOT UPLOADED";
                }
        ...
        // Excel Download
        //District wise excel download(Farmer_Images_Uploaded)
        ...
        //District wise excel download(Farmer_Images_NotUploaded)
        protected void btn_notupload_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataTable dt = ProjectRofrBAL.GetMasterDetails.GetFarmerImagesReport("INDistrict", "", "", "", "", (string)(Session["username"]), (string)Session["userprevilages"]);
        ...
        protected void btn_Farmer_image_not_excel_Click(object sender, EventArgs e)
        {
            ...
            {
                DataTable dt = new DataTable();
                dt = ProjectRofrBAL.GetMasterDetails.GetFarmerImagesReport((string)(Session["inputtype"]), (string)(Session["Itda"]), (string)(Session["District"]), (string)(Session["Mandal"]), (string)(Session["Village"]), (string)(Session["username"]), (string)Session["userprevilages"]);
