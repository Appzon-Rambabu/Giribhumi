...
{
    public partial class Compartments_In_Villages : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    if ((string)(Session["CurrentPage"]) == "Compartments_In_Villages.aspx")
                    {
        ...
        protected void BindData(string Itda, string Mandal)
        {
            try
            {
                DataTable dt = Landsettlementpattas.MandalCompartmentsInTwoMandals(Itda, Mandal);
        ...
        protected void txtsearch_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                dtbeneficiareies = Landsettlementpattas.MandalCompartmentsInTwoMandals((string)(Session["ItdaMandalvalue"]), (string)(Session["Mandalvalue"]));
        ...
        protected void btnsubmit_Click(object sender, EventArgs e)
        {
            try
            {
                DataTable dt = Landsettlementpattas.MandalCompartmentsInTwoMandals((string)(Session["ItdaMandalvalue"]), (string)(Session["Mandalvalue"]));
                //dt = calculatetotals(dt);
                ...
                if (dt.Rows.Count > 0)
                {
                    string filename = "CompartmentsinTwoVillages.xls";
