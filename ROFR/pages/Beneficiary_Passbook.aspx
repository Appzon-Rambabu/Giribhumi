<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ROFR_MASTER.Master" AutoEventWireup="true" CodeBehind="Beneficiary_Passbook.aspx.cs" Inherits="ROFR.pages.Beneficiary_Passbook"  EnableEventValidation="false"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="panel panel-body"  style="margin-top:150px;">
        ...
        <h5 class="text-center text-success mb-4 mt-3">BENEFICIARY PASSBOOK</h5>
        ...
        <div class="row mb-4 justify-content-center">
           ...
           <%-- <div class="col-md-2">
                <asp:Button ID="btn_pdf" runat="server" Text="PDF" OnClick="btn_rdlcpdf_Click"  />


            </div>--%>
                        <div class="col-md-2">
                <asp:Button ID="btn_cpdf" runat="server" Text="Download Epassbook" OnClick="btn_crystalpdf_Click"  />
