...
{
    public partial class RythuBharosa_PaymentStatus_May21 : System.Web.UI.Page
    {
        ...
        protected void BindData()
        {
            try
            {
                ...
                DataTable dt = ProjectRofrBAL.GetMasterDetails.GetRythuBharosaStatus_May21("DISTRICT", "", "", "", "", (string)(Session["username"]), (string)Session["userprevilages"]);
        ...
        protected void link_onclick(object sender, EventArgs e)
        {
            try
            {
                ...
                DataTable dt = ProjectRofrBAL.GetMasterDetails.GetRythuBharosaStatus_May21("MANDAL", (string)(Session["Itda"]), (string)(Session["District"]), "", "", (string)(Session["username"]), (string)Session["userprevilages"]);
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    for (int i = 0; i <= dt.Rows.Count - 1; i++)
                    {
                        for (int j = 0; j <= 4; j++)
                        {
                            ...
                            if (i != dt.Rows.Count - 1)
                            {
                                if ((j == 2 && value == "0") || (j == 3 && value == "0") || (j == 4 && value == "0"))
                                {
                                    string IB = "LinkButton";
                                    IB = IB + j;
                                    string IL = "lbl";
        ...
        protected void Rejected_onclick(object sender, EventArgs e)
        {
            try
            {
                ...
                if (end == "BENEFICIARYFAMILY")
                {
                    dt = ProjectRofrBAL.GetMasterDetails.GetRythuBharosaStatus_May21("Belong to Beneficiary Family", (string)(Session["Itda"]), (string)(Session["District"]), (string)(Session["Mandal"]), "", (string)(Session["username"]), (string)Session["userprevilages"]);
                }
                if (end == "ELIGIBLE")
                {
                    dt = ProjectRofrBAL.GetMasterDetails.GetRythuBharosaStatus_May21("Eligible", (string)(Session["Itda"]), (string)(Session["District"]), (string)(Session["Mandal"]), "", (string)(Session["username"]), (string)Session["userprevilages"]);
                }


                if (end == "INELIGIBLE")
                {
                    dt = ProjectRofrBAL.GetMasterDetails.GetRythuBharosaStatus_May21("Ineligible", (string)(Session["Itda"]), (string)(Session["District"]), (string)(Session["Mandal"]), "", (string)(Session["username"]), (string)Session["userprevilages"]);
                }
