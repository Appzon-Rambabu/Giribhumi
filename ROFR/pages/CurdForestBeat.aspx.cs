                ...
                if (e.CommandName.Equals("AddNew"))
                {
                    ...
                    if (unique == false)
                    {
                        ...
                        if (!string.IsNullOrEmpty((string)(Session["username"])))
                        {
                            ...
                            ProjectRofrBAL.GetMasterDetails.InsertForestBeat(ddl_district.SelectedValue, mandal, village, division, range, FBC.Text.Trim(), FBN.Text.Trim(), IPAddress, sessionstring);
