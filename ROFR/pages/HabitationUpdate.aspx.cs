    ...
    public partial class HabitationUpdate : System.Web.UI.Page
    {
        ...
        private void BindDistrict()
        {
            try
            {
                ...
                DataTable dtDistricts = MastersDataAnalysisBAL.MastersDataAnalysis.GetDistrictdetails(sessionstring, "District", "", "");
        ...
        protected void ddldistrict_OnSelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                if (ddl_district.SelectedItem.Text != "Select")
                {
                    ...
                    DataTable dtMandal = MastersDataAnalysisBAL.MastersDataAnalysis.GetDistrictdetails(sessionstring, "Mandal", ddl_district.SelectedValue, "");
        ...
        protected void ddlmandal_OnSelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                if (ddl_mandal.SelectedItem.Text != "Select")
                {
                    ...
                    DataTable dtmandal = MastersDataAnalysisBAL.MastersDataAnalysis.GetDistrictdetails(sessionstring, "Village", ddl_district.SelectedValue, ddl_mandal.SelectedValue);
                    GridView1.Visible = false;
                    GridView2.Visible = false;
                    if (dtmandal.Rows.Count > 0)
                    {
                ...
                if (e.CommandName.Equals("AddNew"))
                {
                    ...
                    if ((unique == false))
                    {
                        ...
                        if (!string.IsNullOrEmpty((string)(Session["username"])))
                        {
                            ...
                            RevenueDistrictsBAL.RevenueDistricts.InsertForesthab(ddl_district.SelectedValue, mandal, village, ddl_Village.SelectedItem.Text, HAB.Text.Trim(), "", IPAddress, sessionstring);
                ...
                else
                {
                    ...
                    if ((unique == false))
                    {
                        ...
                        if (!string.IsNullOrEmpty((string)(Session["username"])))
                        {
                            ...
                            RevenueDistrictsBAL.RevenueDistricts.UpdateForesthab(id, ddl_district.SelectedValue, mandal, village, HAB.Text.Trim(), "", IPAddress, sessionstring);
