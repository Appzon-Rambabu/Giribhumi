<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ROFR_MASTER.Master" AutoEventWireup="true" CodeBehind="ForestDivision_Analysis.aspx.cs" Inherits="ROFR.pages.ForestDivision_Analysis" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
         ...
         <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
           <asp:UpdateProgress ID="UPDATED" runat="server">
			 ...
			 <div class="row mb-1 mt-1 justify-content-end">
               ...
               <div class="col-md-4"> 
                   <h5 class="text-center text-success mb-1 mt-1 thick" id="Title_Header">FOREST DIVISION MASTER</h5>
               </div>
 ...
 <ItemTemplate>
                <div style="text-align:right">
              <asp:Label  ID="lbl4" runat="server"  Font-Bold="True" Text='<%# Eval("FOREST_DIVISION_CODE") %>'></asp:Label>
                    </div>
            </ItemTemplate>
        </asp:TemplateField> 
 ...
 <ItemTemplate>
                <div style="text-align:left">
              <asp:Label  ID="lbl5" runat="server"  Font-Bold="True" Text='<%# Eval("FOREST_DIVISION_NAME") %>'></asp:Label>
                    </div>
            </ItemTemplate>
        </asp:TemplateField> 
            ...
            <ItemTemplate>
                <asp:Label ID="lbl6" ForeColor="Red"  Font-Bold="True" Text='<%# Eval("NO_OF_RANGES") %>' runat="server" />
  <asp:LinkButton ID="LinkButton6" runat="server" Font-Bold="True" ForeColor="Red" Font-Underline="True"  CommandName="MyUpdate" CommandArgument='<%#Eval("LGD_DISTRICT_CODE")+"-"+Eval("FOREST_DIVISION_CODE")+","+ "6"%>' CausesValidation="false"  Visible ="false"  OnClick="link_onclick" ><%# Eval("NO_OF_RANGES") %></asp:LinkButton>
            </ItemTemplate>
        </asp:TemplateField>  
                    </Columns>  
