...
{
    public partial class Villagewise_Farmer_Images_NDetails : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                if (!IsPostBack)
                {
                    if ((string)(Session["CurrentPage"]) == "Villagewise_Farmer_Images_NDetails.aspx")
                    {
        ...
        protected void BindData(string Itda, string dist, string mandal, string village)
        {
            try
            {
                ...
                DataTable dt = ProjectRofrBAL.GetMasterDetails.GetFarmerImagesReport("VNDetails", Itda, dist, mandal, village, (string)(Session["username"]), (string)Session["userprevilages"]);
