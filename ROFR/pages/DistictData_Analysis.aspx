<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ROFR_MASTER.Master" AutoEventWireup="true" CodeBehind="DistictData_Analysis.aspx.cs" Inherits="ROFR.pages.DistictData_Analysis" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <div class="panel panel-body"> 
	  ...
	  <div class="row mb-1 mt-1 justify-content-end">
               ...
               <div class="col-md-4"> 
                   <h5 class="text-center text-success mb-1 mt-1 thick" id="Title_Header">DISTRICT MASTER</h5>
               </div>
    ...
    <div class="row justify-content-center" style="text-align:right">
     ...
     <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"  class="grid" 
                    BackColor="White" BorderColor="#333" BorderStyle="None" BorderWidth="1px"   
                    CellPadding="4" >  
                    <Columns>   
 ...
 <ItemTemplate>
  ...
  <asp:LinkButton ID="LinkButton4" runat="server" Font-Bold="True" ForeColor="Red" Font-Underline="True"  CommandName="MyUpdate" CommandArgument='<%#Eval("LGD_DISTRICT_CODE")+","+ "3"%>' CausesValidation="false"  Visible ="false"  OnClick="link_onclick" ><%# Eval("NO_OF_MANDALS") %></asp:LinkButton>
          ...
          <asp:LinkButton ID="LinkButton5" runat="server" Font-Bold="True" ForeColor="#009900" Font-Underline="True"  CommandName="MyUpdate" CommandArgument='<%#Eval("LGD_DISTRICT_CODE")+","+ "4"%>' CausesValidation="false"  Visible ="false"  OnClick="link_onclick" ><%# Eval("NO_OF_DIVISIONS") %></asp:LinkButton>
            </ItemTemplate>
        </asp:TemplateField> 
                    </Columns>  
