<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ROFR_MASTER.Master" AutoEventWireup="true" CodeBehind="ForestBeat_Analysis.aspx.cs" Inherits="ROFR.pages.ForestBeat_Analysis" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
          ...
          <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
           <asp:UpdateProgress ID="UPDATED" runat="server">
			...
			<div class="row mb-1 mt-1 justify-content-end">
               ...
               <div class="col-md-4"> 
                   <h5 class="text-center text-success mb-1 mt-1 thick" id="Title_Header">FOREST BEAT MASTER</h5>
               </div>
                  ...
                  <div class="d-flex">
                      <div class="col-auto">
                         ...
                         <input type="Button"  runat="server" id="Btn_Print_District"  class="btn btn-sm btn-success mr-2" value="Print" onclick="PrintGridData()" />&nbsp;&nbsp;
                              <asp:LinkButton ID="btn_back" runat="server"  Font-Underline="true"  OnClick="Get_Range">Back</asp:LinkButton>
                  </div>
                  </div>
 ...
 <ItemTemplate>
                <div style="text-align:right">
              <asp:Label  ID="lbl10" runat="server"  Font-Bold="True" Text='<%# Eval("FOREST_DIVISION_CODE") %>'></asp:Label>
                    </div>
            </ItemTemplate>
        </asp:TemplateField> 
 ...
 <ItemTemplate>
                <div style="text-align:left">
              <asp:Label  ID="lbl11" runat="server"  Font-Bold="True" Text='<%# Eval("FOREST_DIVISION_NAME") %>'></asp:Label>
                    </div>
            </ItemTemplate>
        </asp:TemplateField> 
 ...
 <ItemTemplate>
                <div style="text-align:right">
              <asp:Label  ID="lbl12" runat="server"  Font-Bold="True" Text='<%# Eval("FOREST_RANGE_CODE") %>'></asp:Label>
                    </div>
            </ItemTemplate>
        </asp:TemplateField> 
 ...
 <ItemTemplate>
                <div style="text-align:left">
              <asp:Label  ID="lbl13" runat="server"  Font-Bold="True" Text='<%# Eval("FOREST_RANGE_NAME") %>'></asp:Label>
                    </div>
            </ItemTemplate>
        </asp:TemplateField>
 ...
 <ItemTemplate>
                <div style="text-align:right">
              <asp:Label  ID="lbl14" runat="server"  Font-Bold="True" Text='<%# Eval("FOREST_BEAT_CODE") %>'></asp:Label>
                    </div>
            </ItemTemplate>
        </asp:TemplateField> 
 ...
 <ItemTemplate>
                <div style="text-align:left">
              <asp:Label  ID="lbl15" runat="server"  Font-Bold="True" Text='<%# Eval("FOREST_BEAT_NAME") %>'></asp:Label>
                    </div>
            </ItemTemplate>
        </asp:TemplateField> 
 ...
 <ItemTemplate>
                <div style="text-align:left">
              <asp:Label  ID="lbl16" runat="server"  Font-Bold="True" Text='<%# Eval("HAB_NAME") %>'></asp:Label>
                    </div>
            </ItemTemplate>
        </asp:TemplateField>   
                    </Columns>  
