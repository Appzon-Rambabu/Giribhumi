<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ROFR_MASTER.Master" AutoEventWireup="true" CodeBehind="RPayment_Rejected.aspx.cs" Inherits="ROFR.pages.RPayment_Rejected" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="panel panel-body" > 
         ...
         <div class="row mb-1 mt-1 justify-content-end">
               ...
               <div class="col-md-4"> <h5 class="text-center text-success mb-1 mt-1 thick" id="Title_Header">RYTHU BHAROSA PAYMENT REJECTED DETAILS 2019</h5>
			   </div>
  ...
  <div class="row justify-content-center" style="text-align:right">
      ...
      <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"  class="grid" 
            ...
            <ItemTemplate>
              ...
              <asp:Label Class="txt"  ID="lbl0" runat="server"   Text='<%# Container.DataItemIndex + 1 %>' ForeColor="Black"></asp:Label>
            ...
            <ItemTemplate>
                <div style="text-align:right">
              <asp:Label Class="txt"  ID="lbl1" runat="server"  ForeColor="Blue" Text='<%# Eval("benficiary_id") %>'></asp:Label>
            ...
            <ItemTemplate>
                ...
                <asp:Label ID="lbl1" ForeColor="Green" Font-Bold="True" Text='<%# Eval("Compartment_No") %>' runat="server"  />
   <div style="text-align:left">
            </ItemTemplate>
        </asp:TemplateField> 
                           --%>
            ...
            <ItemTemplate>
                 <asp:Label ID="lbl2" ForeColor="Green" Font-Bold="True" Text='<%# Eval("ROFR_PATTANO") %>' runat="server"  />
            ...
            <ItemTemplate>
                 <asp:Label ID="lbl2" ForeColor="Green" Font-Bold="True" Text='<%# Eval("Plot_No") %>' runat="server"  />
            ...
            <ItemTemplate>
                 <div style="text-align:left">
                 <asp:Label ID="lbl2" ForeColor="Blue"  Text='<%# Eval("ROFR_PATTADAAR") %>' runat="server"  />
           </div>
            </ItemTemplate>
        </asp:TemplateField>
            ...
            <ItemTemplate>
                 <asp:Label ID="lbl2" ForeColor="Green" Font-Bold="True" Text='<%# Eval("RB_Payment_Status") %>' runat="server"  />
                         ...
                         <asp:TemplateField HeaderText="Rejected Reason" ItemStyle-Width = "150" HeaderStyle-ForeColor="White" HeaderStyle-CssClass="header-center">
            <ItemTemplate>
                 <div style="text-align:left">
                 <asp:Label ID="lbl8" ForeColor="Black"  Text='<%# Eval("RB_Rejected_Reason") %>' runat="server"  />
           </div>
            </ItemTemplate>
        </asp:TemplateField>
                    </Columns>  
