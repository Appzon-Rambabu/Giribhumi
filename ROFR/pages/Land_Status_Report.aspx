<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ROFR_MASTER.Master" AutoEventWireup="true" CodeBehind="Land_Status_Report.aspx.cs" Inherits="ROFR.pages.Land_Status_Report"  EnableEventValidation="false"%>
...
.headertable .aftr1 th{position: sticky;top: 29px;}
/*.headertable .aftr2 th{position: sticky;top: 19px;}*/
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
       <div class="panel panel-body" style="margin-top:160px;"> 
         ...
         <div class="row mb-1 mt-1 justify-content-end">
               ...
               <div class="col-md-4"> <h5 class="text-center text-success mb-1 mt-1">ROFR Land Status in Giribhumi</h5></div>
    ...
    <div class="row justify-content-center" style="text-align:right" id="div_dist" runat="server">
       ...
       <div class="headertable">
        ...
        <table border="1" cellpadding="10" width="50%">
              <tr ><th align="center" colspan="3" style="text-align:center;background-color: #2e44df;color: white;"></th>
                  <th align="center" colspan="2" style="text-align:center;background-color: #2e44df;color: white;"> <asp:Label ID="lbl_approved" runat="server" Text="Already Approved"></asp:Label></th>
                  <th align="center" colspan="2" style="text-align:center;background-color: #2e44df;color: white;"><asp:Label ID="lbl_yes" runat="server" Text=""></asp:Label></th>
                  <th align="center" colspan="2" style="text-align:center;background-color: #2e44df;color: white;"><asp:Label ID="lbl_today" runat="server" Text=""></asp:Label></th>
                  <th align="center" colspan="2" style="text-align:center;background-color: #2e44df;color: white;"><asp:Label ID="lbl_cum" runat="server" Text=""></asp:Label></th>
              </tr>
          <tr class="aftr">
					...
					<th  style="text-align: center; vertical-align: middle;background-color: #2e44df;color: white;min-width: 90px;">No of Beneficiries </th>
					<th  style="text-align: center; vertical-align: middle;background-color: #2e44df;color: white;min-width: 90px;">Extent (Acres)s</th>
					<th  style="text-align: center; vertical-align: middle;background-color: #2e44df;color: white;min-width: 90px;">No of Beneficiaries</th>
					<th  style="text-align: center; vertical-align: middle;background-color: #2e44df;color: white;min-width: 90px;">Extent (Acres)</th>
					<th  style="text-align: center; vertical-align: middle;background-color: #2e44df;color: white;min-width: 90px;">No of Beneficiaries</th>
					<th  style="text-align: center; vertical-align: middle;background-color: #2e44df;color: white;min-width: 90px;">Extent (Acres)</th>
								<th  style="text-align: center; vertical-align: middle;background-color: #2e44df;color: white;min-width: 90px;">No of Beneficiaries</th>
          		<th  style="text-align: center; vertical-align: middle;background-color: #2e44df;color: white;min-width: 90px;">Extent (Acres)</th>
