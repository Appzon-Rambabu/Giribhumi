...
{
    public partial class ViewLandTransferRegulation : System.Web.UI.Page
    {
        ...
        private void BindMandals()
        {
            try
            {
                DataTable dtMandals = Landsettlementpattas.GetmandalMasterAnalysis();
                if (dtMandals.Rows.Count > 0)
                {
                    ddl_mandalname.DataSource = dtMandals;
                    ddl_mandalname.DataTextField = "MandalName";
                    ddl_mandalname.DataValueField = "MandalCode";
        ...
        protected void Linkview_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Response.Redirect("LandTransferRegulation.aspx");
