<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ROFR_MASTER.Master" AutoEventWireup="true" CodeBehind="View_Epassbook.aspx.cs" Inherits="ROFR.pages.View_Epassbook" EnableEventValidation="false" %>
                                ...
                                <div class="row mb-2">
                                    <div class="col-md-12 d-flex justify-content-between">
                                     ...
                                     <%--   <input type="submit" class="btn btn-info" value="Download Epassbook" />--%>
                                         <asp:Button ID="btn_passbook" runat="server" class="btn btn-success" Text="Download Epassbook" OnClick="Button1_Click"  CssClass="btn btn-info"/>
                                    </div>
                                </div>
                            </div>
