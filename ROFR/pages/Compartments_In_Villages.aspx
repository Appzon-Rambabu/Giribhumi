<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/HOME.Master" AutoEventWireup="true" CodeBehind="Compartments_In_Villages.aspx.cs" Inherits="ROFR.pages.Compartments_In_Villages" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <div class="panel panel-body" style="margin-top:80px;"> 
          ...
          <div class="row mb-2">
              <div class="col-md-10">
                  <h5 class="text-center text-success mb-2 mt-3 offset-2">COMPARTMENT COVERED IN TWO VILLAGES</h5>
              </div>
              <div class="col-md-2">
     ...
     <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"   
            ...
            <ItemTemplate>
              ...
              <asp:Label Class="txt"  ID="lbl0" runat="server"  Font-Bold="True" Text='<%# Container.DataItemIndex + 1  %>'></asp:Label>
                         ...
                         <asp:TemplateField HeaderText="Compartment Number"  HeaderStyle-ForeColor="White" HeaderStyle-CssClass="header-center">
            <ItemTemplate>
               <div style="text-align:center">
                    <asp:Label ID="lbl1"  Font-Bold="True" Text='<%# Eval("Compartment_No") %>' runat="server"  ForeColor="Red"/>
            ...
            <ItemTemplate>
                <div style="text-align:left">
                  <%--<asp:LinkButton ID="LinkButton2" runat="server" Font-Bold="True" ForeColor="Red"  Font-Underline="true"   CommandName="MyUpdate" CommandArgument= '<%#Eval("Village") + "," +Eval("Total_Compartments")%>' CausesValidation="false"   OnClick="link_onclick" ><%# Eval("Total_Compartments") %></asp:LinkButton>--%>
             <asp:Label ID="lbl2"  Font-Bold="True" Text='<%# Eval("Village") %>' runat="server"  />
                    </div>
            </ItemTemplate>
        </asp:TemplateField> 
