<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ROFR_MASTER.Master" AutoEventWireup="true" CodeBehind="DataAnalysis_NonMandatoryFields.aspx.cs" Inherits="ROFR.pages.DataAnalysis_NonMandatoryFields" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="panel panel-body" style="margin-top:-10px;"> 
		  ...
		  <div class="col-md-4">
            <h5 class="text-center text-success mb-2 mt-3 thick" id="Title_Header"> DATA ANALYSIS REPORT FOR NONMANDATORY FIELDS</h5>
	       </div>
     ...
     <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"  CssClass="grid"  
            ...
            <ItemTemplate>
                <div style="text-align:right">
              <asp:Label Class="txt"  ID="lbl1" runat="server" ForeColor="Green"  Font-Bold="True" Text='<%# Eval("HAVING_MANDAL_CODE") %>'></asp:Label>
                    </div>
            </ItemTemplate>
            ...
            <ItemTemplate>
                <div style="text-align:right">
              <asp:Label Class="txt"  ID="lbl1" runat="server" ForeColor="Green"  Font-Bold="True" Text='<%# Eval("HAVING_VILLAGE_CODE") %>'></asp:Label>
                    </div>
            </ItemTemplate>
        </asp:TemplateField>
            ...
            <ItemTemplate>
                <div style="text-align:right">
              <asp:Label Class="txt"  ID="lbl1" runat="server"  ForeColor="Green" Font-Bold="True" Text='<%# Eval("GRAM_PANCHAYAT_CODE") %>'></asp:Label>
                    </div>
            </ItemTemplate>
        </asp:TemplateField>
            ...
            <ItemTemplate>
                <div style="text-align:right">
              <asp:Label Class="txt"  ID="lbl1" runat="server" ForeColor="Green"   Font-Bold="True" Text='<%# Eval("Habitation_CODE") %>'></asp:Label>
                    </div>
            </ItemTemplate>
        </asp:TemplateField>
            ...
            <ItemTemplate>
                <div style="text-align:right">
              <asp:Label Class="txt"  ID="lbl1" runat="server" ForeColor="Green"  Font-Bold="True" Text='<%# Eval("HAVING_FOREST_DIVISION_CODE") %>'></asp:Label>
                    </div>
            </ItemTemplate>
        </asp:TemplateField>
            ...
            <ItemTemplate>
                <div style="text-align:right">
              <asp:Label Class="txt"  ID="lbl1" runat="server" ForeColor="Green"  Font-Bold="True" Text='<%# Eval("HAVING_FOREST_RANGE_CODE") %>'></asp:Label>
                    </div>
            </ItemTemplate>
        </asp:TemplateField>
            ...
            <ItemTemplate>
                <div style="text-align:right">
              <asp:Label Class="txt"  ID="lbl1" runat="server" ForeColor="Green"  Font-Bold="True" Text='<%# Eval("HAVING_FOREST_BEAT_CODE") %>'></asp:Label>
                    </div>
            </ItemTemplate>
        </asp:TemplateField>
            ...
            <ItemTemplate>
                <div style="text-align:right">
              <asp:Label Class="txt"  ID="lbl1" runat="server" ForeColor="Green"   Font-Bold="True" Text='<%# Eval("PLOTS_HAVING_Uncultivable_Land") %>'></asp:Label>
                    </div>
            </ItemTemplate>
        </asp:TemplateField>
            ...
            <ItemTemplate>
                <div style="text-align:right">
              <asp:Label Class="txt"  ID="lbl1" runat="server" ForeColor="Green"  Font-Bold="True" Text='<%# Eval("HAVING_Cultivable_Land") %>'></asp:Label>
                    </div>
            </ItemTemplate>
        </asp:TemplateField>
            ...
            <ItemTemplate>
                <div style="text-align:right">
              <asp:Label Class="txt"  ID="lbl1" runat="server" ForeColor="Green"  Font-Bold="True" Text='<%# Eval("PLOTS_HAVING_Water_Tax") %>'></asp:Label>
                    </div>
            </ItemTemplate>
        </asp:TemplateField>
            ...
            <ItemTemplate>
                <div style="text-align:right">
              <asp:Label Class="txt"  ID="lbl1" runat="server" ForeColor="Green"  Font-Bold="True" Text='<%# Eval("HAVING_DRYID_ONECROP_TWO_CROP") %>'></asp:Label>
                    </div>
            </ItemTemplate>
        </asp:TemplateField>
            ...
            <ItemTemplate>
                <div style="text-align:right">
              <asp:Label Class="txt"  ID="lbl1" runat="server" ForeColor="Green"  Font-Bold="True" Text='<%# Eval("PLOTS_HAVING_WATER_SOURCE") %>'></asp:Label>
                    </div>
            </ItemTemplate>
        </asp:TemplateField>
            ...
            <ItemTemplate>
                <div style="text-align:right">
              <asp:Label Class="txt"  ID="lbl1" runat="server" ForeColor="Green"  Font-Bold="True" Text='<%# Eval("PLOTS_HAVING_EXTENT_IRRIGATED") %>'></asp:Label>
                    </div>
            </ItemTemplate>
        </asp:TemplateField>
            ...
            <ItemTemplate>
                <div style="text-align:right">
              <asp:Label Class="txt"  ID="lbl1" runat="server" ForeColor="Green"  Font-Bold="True" Text='<%# Eval("PLOTS_HAVING_EXTENT_UNDER_CULTIVATOR") %>'></asp:Label>
                    </div>
            </ItemTemplate>
        </asp:TemplateField>
            ...
            <ItemTemplate>
                <div style="text-align:right">
              <asp:Label Class="txt"  ID="lbl1" runat="server" ForeColor="Green"  Font-Bold="True" Text='<%# Eval("PLOTS_HAVING_TYPE_CODE") %>'></asp:Label>
                    </div>
            </ItemTemplate>
            ...
            <ItemTemplate>
                <div style="text-align:right">
              <asp:Label Class="txt"  ID="lbl1" runat="server"  ForeColor="Green"  Font-Bold="True" Text='<%# Eval("PLOTS_HAVING_NET_SOWN_AREA") %>'></asp:Label>
                    </div>
            </ItemTemplate>
        </asp:TemplateField>
            ...
            <ItemTemplate>
                <div style="text-align:right">
              <asp:Label Class="txt"  ID="lbl1" runat="server" ForeColor="Green"  Font-Bold="True" Text='<%# Eval("PLOTS_HAVING_KHARIFF_RABI") %>'></asp:Label>
                    </div>
            </ItemTemplate>
        </asp:TemplateField>
            ...
            <ItemTemplate>
                <div style="text-align:right">
              <asp:Label Class="txt"  ID="lbl1" runat="server" ForeColor="Green"  Font-Bold="True" Text='<%# Eval("PLOTS_HAVING_MONTH_OF_CULTIVATION") %>'></asp:Label>
                    </div>
            </ItemTemplate>
        </asp:TemplateField>
            ...
            <ItemTemplate>
                <div style="text-align:right">
              <asp:Label Class="txt"  ID="lbl1" runat="server" ForeColor="Green"  Font-Bold="True" Text='<%# Eval("PLOTS_HAVING_CROP") %>'></asp:Label>
                    </div>
            </ItemTemplate>
        </asp:TemplateField>
            ...
            <ItemTemplate>
                <div style="text-align:right">
              <asp:Label Class="txt"  ID="lbl1" runat="server" ForeColor="Green"  Font-Bold="True" Text='<%# Eval("PLOTS_HAVING_EXTENT_SINGLE") %>'></asp:Label>
                    </div>
            </ItemTemplate>
        </asp:TemplateField>
            ...
            <ItemTemplate>
                <div style="text-align:right">
              <asp:Label Class="txt"  ID="lbl1" runat="server" ForeColor="Green"  Font-Bold="True" Text='<%# Eval("PLOTS_HAVING_EXTENT_MIXED") %>'></asp:Label>
                    </div>
            </ItemTemplate>
        </asp:TemplateField>
            ...
            <ItemTemplate>
                <div style="text-align:right">
              <asp:Label Class="txt"  ID="lbl1" runat="server" ForeColor="Green"  Font-Bold="True" Text='<%# Eval("PLOTS_HAVING_EXTENT_TOTAL") %>'></asp:Label>
                    </div>
            </ItemTemplate>
        </asp:TemplateField>
            ...
            <ItemTemplate>
                <div style="text-align:right">
              <asp:Label Class="txt"  ID="lbl1" runat="server" ForeColor="Green"  Font-Bold="True" Text='<%# Eval("PLOTS_HAVING_FIRST_CROP") %>'></asp:Label>
                    </div>
            </ItemTemplate>
        </asp:TemplateField>
            ...
            <ItemTemplate>
                <div style="text-align:right">
              <asp:Label Class="txt"  ID="lbl1" runat="server" ForeColor="Green"  Font-Bold="True" Text='<%# Eval("PLOTS_HAVING_SECOND_THIRD_CROP") %>'></asp:Label>
                    </div>
            </ItemTemplate>
        </asp:TemplateField>
            ...
            <ItemTemplate>
                <div style="text-align:right">
              <asp:Label Class="txt"  ID="lbl1" runat="server" ForeColor="Green"  Font-Bold="True" Text='<%# Eval("PLOTS_HAVING_CROP_YIELD") %>'></asp:Label>
                    </div>
            </ItemTemplate>
        </asp:TemplateField>
            ...
            <ItemTemplate>
                <div style="text-align:right">
              <asp:Label Class="txt"  ID="lbl1" runat="server" ForeColor="Green"  Font-Bold="True" Text='<%# Eval("PLOTS_HAVING_REMARKS") %>'></asp:Label>
                    </div>
            </ItemTemplate>
        </asp:TemplateField>
