<%@ Page Title="Forest Beat Master Details" Language="C#" MasterPageFile="~/Masters/ROFR_MASTER.Master" AutoEventWireup="true" CodeBehind="NewForestBeatMapping.aspx.cs" Inherits="ROFR.pages.NewForestBeatMapping" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <thead>
    <tr>
      <h5 class="text-center text-success">Revenue Village - Forest Beat Master</h5>
    </tr>
  </thead>
  <tbody>
    <tr>
      ...
      <td> <asp:Label ID="txt_village"  runat="server" Text="Village:"></asp:Label>&nbsp<asp:Label ID="Label4" runat="server" Text="*" ForeColor="Red"></asp:Label></td>
      <td><asp:DropDownList ID="ddl_village"  style="width:150px" AutoPostBack="true" OnSelectedIndexChanged="ddlvillage_OnSelectedIndexChanged" runat="server"></asp:DropDownList>  </td>
    </tr>
           ...
           <table class="table table-bordered table-striped" border="0" cellpadding="0" cellspacing="0" width="100%">
            ...
            <table id="gvMain" style=" border-collapse: collapse;" align="center" border="1" bordercolor="lightgrey">
                    ...
                    <th style="text-align: center" >LGD DISTRICT  CODE<br />(2)</th> 
                        ...
                        <th style="text-align: center" >REVENUE DISTRICT CODE <br />(3)</th>  
                         ...
                         <th style="text-align: center" >LGD MANDAL  CODE<br />(4)</th>  
                             <th style="text-align: center" >REVENUE MANDAL CODE<br />(5)</th>  
                                <th style="text-align: center" >REVENUE VILLAGE CODE<br />(6)</th> 
                         <th style="text-align: center" >LGD VILLAGE  CODE<br />(7)</th>   
                            
                            <th style="text-align: center" >FOREST DIVISION CODE<br />(8)</th> 
                            <th style="text-align: center" >FOREST DIVISION NAME<br />(9)</th> 
                             <th style="text-align: center" >FOREST RANGE CODE<br />(10)</th>
                            <th style="text-align: center" >FOREST RANGE NAME<br />(11)</th>   
                            <th style="text-align: center" >FOREST BEAT CODE<br />(12)</th>  
                            <th style="text-align: center" >FOREST BEAT NAME<br />(13)</th> 
                        
                         <th style="text-align: center" >HABITATION NAME<br />(14)</th>       
            ...
            <ItemTemplate>
                ...
                <tr class="GridViewScrollItem">
                    ...
                    <td style="text-align: center" >  <%#DataBinder.Eval(Container, "DataItem.LGD_MANDAL_CODE")%> </td>

                  <td style="text-align: center" >  <%#DataBinder.Eval(Container, "DataItem.REV_MANDAL_CODE")%>  </td>
                    <td style="text-align: center" >  <%#DataBinder.Eval(Container, "DataItem.REV_VILLAGE_CODE")%> </td>
                       <td style="text-align: center" >  <%#DataBinder.Eval(Container, "DataItem.LGD_VILLAGE_CODE")%> </td>
                    ...
                    <%--  
                      <td style="text-align: center" >  <%#DataBinder.Eval(Container, "DataItem.VILLAGE_NAME")%> </td>--%>
                       ...
                       <td style="text-align: center" >  <%#DataBinder.Eval(Container, "DataItem.HAB_NAME")%> </td>
