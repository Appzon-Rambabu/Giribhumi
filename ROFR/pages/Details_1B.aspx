<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Adangal.master" AutoEventWireup="true" CodeBehind="Details_1B.aspx.cs" Inherits="ROFR.pages.Details_1B" EnableEventValidation="false" %>
  ...
  <div class="container-fluid">
         ...
         <%-- <asp:ListItem Value="B">Patta No.&nbsp&nbsp</asp:ListItem>--%>
          ...
          <asp:ListItem Value="D">Pattadar Name</asp:ListItem>
                                        ...
                                        <div class="row mb-2">
                                            <div class="col-md-4 text-right">  <asp:Label ID="txt_rbtn" runat="server" Text="Compartment No."></asp:Label><span style="color:Red;">*</span> : </div>
                                            <div class="col-md-4 text-left">
                                               <%-- <div class="form-group">--%>
                                                 <asp:HiddenField ID="HiddenField1" runat="server" />
                                                  <asp:TextBox ID="txt_rbtn_list" CssClass="form-control" MaxLength="12"   onchange="return text()" runat="server" ></asp:TextBox>
