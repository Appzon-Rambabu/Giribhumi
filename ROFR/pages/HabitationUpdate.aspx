<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ROFR_MASTER.Master" AutoEventWireup="true" CodeBehind="HabitationUpdate.aspx.cs" Inherits="ROFR.pages.HabitationUpdate"  EnableEventValidation="false"%>
      ...
      onrowcommand="gridView_RowCommand"
        OnRowDataBound="gridView_RowDataBound">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="HABITATION NAME" ItemStyle-Width="190">
                                            <ItemTemplate>
                                                <asp:Label ID="lbl_divisioncode" runat="server" Text='<%# Eval("HAB_NAME") %>'></asp:Label>
