...
namespace ROFR.pages
{
    public partial class Beneficiary_Transaction : System.Web.UI.Page
    {
        protected void Page_Init(object sender, EventArgs e)
        {
            ...
            DDL_Pha1_Pha2.Items.Insert(0, new ListItem("Select", "0"));
            ...
            ddl_rev_vlg.Items.Insert(0, new ListItem("Select", "0"));
           // ddl_holding.Items.Insert(0, new ListItem("Select", "0"));
        }
        ...
        protected void btn_submit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    lbl_Panchayat.Text = dt.Rows[0]["Gram_Panchayat"].ToString();
                    lbl_Revvillage.Text = dt.Rows[0]["REV_Village"].ToString();
                    ...
                    Session["Adhar"] = dt.Rows[0]["Aadhaar_NO1"].ToString();
        ...
        private void BindRevenueVillage(DataTable dtRv)
        {
            try
            {
                ddl_rev_vlg.DataSource = dtRv;
                ddl_rev_vlg.DataTextField = "REV_Village";
                ddl_rev_vlg.DataValueField = "REV_VILLAGE_CODE";
                ddl_rev_vlg.DataBind();
                ddl_rev_vlg.Items.Insert(0, new ListItem("Select", "0"));
        ...
        private void land_classification()
        {
            try
            {
                ...
                {
                    ScriptManager.RegisterClientScriptBlock(Page, typeof(Page), "ClientScript", "alert('No Data Found Of Land !')", true);
                }
            }
            catch (Exception ex)
            {
            ...
            try
            {
                ...
                if (ddl_district.SelectedItem.Text != "Select")
                {
                  ...
                  //  DataTable dtMandal = RevenueDistrictsBAL.RevenueDistricts.Getcheckergridmasters((string)(Session["username"]), "RevenueMandals", ddl_district.SelectedValue, Lbl_itda.Text, " ");
                    ...
                    DataTable dtFDivisions = Landsettlementpattas.GetRofrMasters1((string)(Session["username"]), "Division", (string)(Session["itdacode"]), ddl_district.SelectedValue, "", "","", "", "", (string)Session["userprevilages"]);
        ...
        protected void ddl_village_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    DataTable dthab = Landsettlementpattas.GetRofrMasters1((string)(Session["username"]), "Habitation", (string)(Session["itdacode"]), ddl_district.SelectedValue, ddl_mandal.SelectedItem.Text, ddl_gp.SelectedItem.Text, ddl_rev_vlg.SelectedItem.Text,ddl_village.SelectedItem.Text, "", (string)Session["userprevilages"]);
            ...
            try
            {
               ...
               ddl_beat.Items.Insert(0, new ListItem("Select", "0"));
                if (ddl_division.SelectedItem.Text != "Select")
                {
                    ...
                    DataTable dtFRanges = Landsettlementpattas.GetRofrMasters1((string)(Session["username"]), "Range", (string)(Session["itdacode"]), ddl_district.SelectedValue, ddl_division.SelectedItem.Text, "", "", "", "", (string)Session["userprevilages"]);
        ...
        protected void ddl_range_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    DataTable dtFBeats = Landsettlementpattas.GetRofrMasters1((string)(Session["username"]), "Beat", (string)(Session["itdacode"]), ddl_district.SelectedValue, ddl_division.SelectedItem.Text, ddl_range.SelectedItem.Text, "", "", "", (string)Session["userprevilages"]);
        ...
        private void bind_patta_inam()
        {
            try
            {
                ...
                {
                    ScriptManager.RegisterClientScriptBlock(Page, typeof(Page), "ClientScript", "alert('No Data Found Of Patta !')", true);
                }
            }
            catch (Exception ex)
            {
        ...
        private void bind_dry_id()
        {
            try
            {
                ...
                {
                    ScriptManager.RegisterClientScriptBlock(Page, typeof(Page), "ClientScript", "alert('No Data Found Of Dry!')", true);
                }
            }
            catch (Exception ex)
            {
        ...
        private void bind_khariff()
        {
            try
            {
                ...
                {
                    ScriptManager.RegisterClientScriptBlock(Page, typeof(Page), "ClientScript", "alert('No Data Found Of Khariff !')", true);
                }
            }
            catch (Exception ex)
            {
        ...
        private void bind_month_cultivation()
        {
            try
            {
                ...
                {
                    ScriptManager.RegisterClientScriptBlock(Page, typeof(Page), "ClientScript", "alert('No Data Found Of Month !')", true);
                }
            }
            catch (Exception ex)
            {
        ...
        protected void Submit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (ddl_district.SelectedValue == "0")
                    ...
                    {
                        ScriptManager.RegisterStartupScript(this, this.GetType(), "alertmessage", "javascript:alert(' Please select Mandal')", true);
                    }
                    if (ddl_village.SelectedValue == "0")
                    {
                        ScriptManager.RegisterStartupScript(this, this.GetType(), "alertmessage", "javascript:alert(' Please select Village')", true);
                    }
                    if (ddl_division.SelectedValue == "0")
                    {
                        ScriptManager.RegisterStartupScript(this, this.GetType(), "alertmessage", "javascript:alert(' Please select Division')", true);
                    }
                if (ddl_gp.SelectedValue == "0")
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "alertmessage", "javascript:alert(' Please select Grampanchayat')", true);
                }
                if (ddl_rev_vlg.SelectedValue == "0")
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "alertmessage", "javascript:alert(' Please select Revenue Village')", true);
                }
                if (string.IsNullOrEmpty(txt_patta_no.Text)||txt_patta_no.Text=="0")
                    {
                        ScriptManager.RegisterStartupScript(this, this.GetType(), "alertmessage", "javascript:alert(' Please Enter Patta number')", true);
                    }
                    if (string.IsNullOrEmpty(txt_compartment.Text)|| txt_compartment.Text=="0")
                    {
                        ScriptManager.RegisterStartupScript(this, this.GetType(), "alertmessage", "javascript:alert(' Please Enter Compartment number')", true);
                    }
                 
                    if (string.IsNullOrEmpty(txt_plotarea.Text)||txt_plotarea.Text=="0"|| txt_plotarea.Text=="0.00" || txt_plotarea.Text == "0.0")
                    {
                        ScriptManager.RegisterStartupScript(this, this.GetType(), "alertmessage", "javascript:alert(' Please Enter Extent Plot Area')", true);
                    }
                    if (string.IsNullOrEmpty(txt_patta_inam.Text))
                    {
                        ScriptManager.RegisterStartupScript(this, this.GetType(), "alertmessage", "javascript:alert(' Please Enter Patta InamGovt')", true);
                    }
                    if (DDL_Pha1_Pha2.SelectedValue == "0")
                    {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "alertmessage", "javascript:alert(' Please select Phase-1/Phase-2')", true);
                    return;

                }
                //if (string.IsNullOrEmpty(txt_cname.Text))
                //    {
                //        ScriptManager.RegisterStartupScript(this, this.GetType(), "alertmessage", "javascript:alert(' Please Enter Cultivator Name')", true);
                //    }

                //if (string.IsNullOrEmpty(txt_holding.Text))
                //{
                //    ScriptManager.RegisterStartupScript(this, this.GetType(), "alertmessage", "javascript:alert(' Please Enter Holding Nature')", true);
                //}
                if (ddl_holding.SelectedValue == "0")
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "alertmessage", "javascript:alert('Please Select Holding Nature')", true);
                    return;
                ...
                if (string.IsNullOrEmpty(txt_land_class.Text))
                    {
                        ScriptManager.RegisterStartupScript(this, this.GetType(), "alertmessage", "javascript:alert(' Please Enter Land Classification')", true);
                    }




                if (ddl_district.SelectedValue != "0" && ddl_mandal.SelectedValue != "0" && ddl_village.SelectedValue != "0" && ddl_division.SelectedValue != "0" && ddl_gp.SelectedValue != "0" && ddl_rev_vlg.SelectedValue != "0" && !string.IsNullOrEmpty(txt_patta_no.Text) && txt_patta_no.Text !="0" && !string.IsNullOrEmpty(txt_compartment.Text)&& txt_compartment.Text!="0" && !string.IsNullOrEmpty(txt_plotarea.Text) && txt_plotarea.Text!="0"&& txt_plotarea.Text !="0.0" &&txt_plotarea.Text!="0.00" && !string.IsNullOrEmpty(txt_patta_inam.Text) && /*!string.IsNullOrEmpty(txt_cname.Text) &&*/ ddl_holding.SelectedValue != "0" && !string.IsNullOrEmpty(txt_land_class.Text))
                {
                    if (txt_compartment.Text == "ORF" || txt_compartment.Text == "ENCL" || txt_compartment.Text == "ENCLOSURE")
                    {
                        s_block.Style.Add("display", "none");
                        data_insert();
                    }
                    else if (string.IsNullOrEmpty(txt_fblock.Text))
                    {

                        {
                            s_block.Style.Add("display", "block");
                            ScriptManager.RegisterStartupScript(this, this.GetType(), "alertmessage", "javascript:alert(' Please Enter Block')", true);
                        }
                    }
                    else
                    {
        ...
        private void Reset()
        {
            ...
            ddl_rev_vlg.ClearSelection();
            DDL_Pha1_Pha2.ClearSelection();
            ddl_holding.ClearSelection();
            txt_fblock.Text = "";
        ...
        private void data_insert()
        {
           ...
           string APUniqueID = ag.GenerateLandParcelId();
            ...
            if (ddl_rev_vlg.SelectedItem.Text != "Select")
            {
                addbeneficiaryobj.rev_village = ddl_rev_vlg.SelectedItem.Text;
            }
            else
            {
                addbeneficiaryobj.rev_village = null;
            }
            if (!string.IsNullOrEmpty(ddl_rev_vlg.SelectedValue) || (ddl_rev_vlg.SelectedValue != "0"))
            {
                addbeneficiaryobj.rev_village_code = ddl_rev_vlg.SelectedValue;
            }
            else
            {
            ...
            if (DDL_Pha1_Pha2.SelectedItem.Text != "Select")
            {
                addbeneficiaryobj.Phase_Name = DDL_Pha1_Pha2.SelectedItem.Text;
            }
            else
            {
                addbeneficiaryobj.Phase_Name = null;
            }
            ...
            if (ddl_holding.SelectedItem.Text != "Select")
            {
                addbeneficiaryobj.HOLDING_NATURE = ddl_holding.SelectedItem.Text;
            }
            else
            {
                addbeneficiaryobj.HOLDING_NATURE = null;
            ...
            {
                addbeneficiaryobj.Aadhaar_NO = (string)(Session["Adhar"]);
            }
            else
            {
            ...
            addbeneficiaryobj.ApUniqueID = APUniqueID;
            if (!string.IsNullOrEmpty(addbeneficiaryobj.UserName))
            {
                try
                {
                    DataTable dt = ProjectRofrBAL.GetMasterDetails.AddBeneficiaryDetails(addbeneficiaryobj);
                    if (dt.Rows.Count > 0 && dt != null)
                    {
                        ...
                        {
                            ScriptManager.RegisterStartupScript(this, this.GetType(), "alertmessage", "javascript:alert(' Insertion Failed...Beneficiary Plot Details with same extent already exists')", true);
                        }
                        else if (dt.Rows[0]["STATUS"].ToString() == "102")
                        {
                            ScriptManager.RegisterStartupScript(this, this.GetType(), "alertmessage", "javascript:alert(' Insertion Failed...Please Update Aadhar Number For Beneficiary')", true);
                        }
                        else if (dt.Rows[0]["STATUS"].ToString() == "103")
                        {
                        ...
                        {
                            ScriptManager.RegisterStartupScript(this, this.GetType(), "alertmessage", "javascript:alert(' Beneficiary Details Insertion Failed...')", true);
                        }
                    }
                }
                catch (Exception ex)
        ...
        protected void ddl_gp_SelectedIndexChanged(object sender, EventArgs e)
        {
            DataTable dtRv = Landsettlementpattas.GetRofrMasters1((string)(Session["username"]), "RV", (string)(Session["itdacode"]), ddl_district.SelectedValue, ddl_mandal.SelectedItem.Text, ddl_gp.SelectedItem.Text, "", "", "", (string)Session["userprevilages"]);

            if (dtRv.Rows.Count > 0)
            {
                BindRevenueVillage(dtRv);
            }
            else
            {
                ScriptManager.RegisterClientScriptBlock(Page, typeof(Page), "ClientScript", "alert('No Data Found !')", true);
        ...
        protected void ddl_rev_vlg_SelectedIndexChanged(object sender, EventArgs e)
        {
            DataTable dtVillages = Landsettlementpattas.GetRofrMasters1((string)(Session["username"]), "Village", (string)(Session["itdacode"]), ddl_district.SelectedValue, ddl_mandal.SelectedItem.Text, ddl_gp.SelectedItem.Text, ddl_rev_vlg.SelectedItem.Text, "", "", (string)Session["userprevilages"]);
