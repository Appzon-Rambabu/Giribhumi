...
namespace ROFR.pages
{
    public partial class BeneficaryExtentLandView : System.Web.UI.Page
    {
        ...
        //        mapFrame.Attributes["src"] = "../pages/BeneficaryLandView.aspx";
        ...
        protected void btnmap_Click(object sender, EventArgs e)
        {
            try
            {
                string mapId = Convert.ToString(Session["latlongId"]);

                if (!string.IsNullOrWhiteSpace(mapId))
                {
                    Session["BeneficaryMapid"] = mapId;

                    string script = "document.getElementById('"
                                    + mapFrame.ClientID
                                    + "').src='../pages/BeneficaryLandView.aspx?t="
                                    + DateTime.Now.Ticks + "';";
                ...
                else
                {
                    ScriptManager.RegisterStartupScript(
                        ...
                        this.GetType(),
                        "NoMapId",
                        "alert('Map ID not found. Please select Extent again.');",
                        true
                    );
                }
            }
