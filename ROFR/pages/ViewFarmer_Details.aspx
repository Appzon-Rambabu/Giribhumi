<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ROFR_MASTER.Master" AutoEventWireup="true" CodeBehind="ViewFarmer_Details.aspx.cs" Inherits="ROFR.pages.ViewFarmer_Details"  EnableEventValidation="false"%>
                ...
                <div class="row" style="margin-top:-10px;">
                    ...
                    <main role="main" class="col-md-12 ml-sm-auto col-lg-12 px-4">
                        ...
                        <body >
						 ...
						 <asp:UpdateProgress ID="UPDATED" runat="server" AssociatedUpdatePanelID="UpdatePanel1">
    <ProgressTemplate>
            ...
            <span id="loading-msg">
                <img src="../Rofrnewassets/images/aplogo.png" />
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-md-6">
                                        <h5 class="text-center text-white rounded py-1 bg-nav">View Farmer Plots</h5>
          ...
          <asp:ListItem Value="D">Pattadar Name</asp:ListItem>
                                ...
                                <asp:DropDownList ID="ddl_pattadhar" CssClass="form-control" runat="server" Visible="false"></asp:DropDownList>
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-md-4 text-left">
                                                <%--<div class="form-group">--%>
                                                 <input type="text" id="txtInput" name="captcha" class="form-control" autocomplete="off"  runat="server"/>
                                                <%--</div>--%>
                                            </div>
                                        </div>
              ...
              <asp:Label Class="txt"  ID="lbl0" runat="server"  Font-Bold="True" Text='<%# Eval("Compartment_No") %>' ></asp:Label>
                    </div>
            </ItemTemplate>
        </asp:TemplateField> 
               ...
               <asp:TemplateField HeaderText="ROFR Patta No." HeaderStyle-ForeColor="White" HeaderStyle-CssClass="header-center">
                ...
                <div style="text-align:center">
                    ...
                    <asp:Label ID="lbl10"  Font-Bold="True" Text='<%# Eval("ROFR_PATTANO") %>'  runat="server" />
                    </div>
            </ItemTemplate>
        </asp:TemplateField>
            ...
            <ItemTemplate>
                  ...
                  <asp:Label ID="lbl2"  Font-Bold="True" Text='<%# Eval("ROFR_PATTADAAR") %>' runat="server"/>
            </div>
                      </ItemTemplate>
        </asp:TemplateField> 
