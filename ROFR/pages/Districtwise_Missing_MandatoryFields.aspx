<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ROFR_MASTER.Master" AutoEventWireup="true" CodeBehind="Districtwise_Missing_MandatoryFields.aspx.cs" Inherits="ROFR.pages.Districtwise_Missing_MandatoryFields" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel panel-body"  style="margin-top:-15px;">
         <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
		  ...
		  <div class="col-md-4">
                  <span style="color: red">NOTE: Select ITDA and District and Click on Excel to download all records at once</span>
                  </div>
              <div class="col-md-4">
                  <h5 class="text-center text-success mb-2 mt-3 thick" id="Title_Header">DISTRICT WISE MISSING MANDATORY FIELDS BENEFICIARY DETAILS</h5>
                  </div>
       ...
       <%--<div class="row mt-2 mb-3 justify-content-left"> 
	   <span style="color: red">NOTE: Select ITDA and District and Click on Excel to download all records at once</span></div>--%>
