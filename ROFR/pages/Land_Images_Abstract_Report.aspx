<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ROFR_MASTER.Master" AutoEventWireup="true" CodeBehind="Land_Images_Abstract_Report.aspx.cs" Inherits="ROFR.pages.Land_Images_Abstract_Report" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <asp:UpdatePanel runat="server">
       ...
       <div class="panel panel-body"> 
            ...
            <div class="row mb-1 mt-1 justify-content-end">
               ...
               <div class="col-md-4"> <h5 class="text-center text-success mb-1 mt-1 thick" id="Title_Header">Rofr Stone Plantation Report</h5></div>
                  ...
                  <div class="d-flex">
                      <div class="col-auto">
                         ...
                         <asp:Button ID="btn_upload" class="btn btn-sm btn-success"  AutoPostBack="true" OnClick="btnupload_Click" runat="server" Text="EXCEL" />&nbsp;&nbsp;
                          ...
                          <asp:Button ID="btnmandnothaving" class="btn btn-sm btn-success"  AutoPostBack="true" OnClick="btnmandnothaving_Click" runat="server" Text="EXCEL" Visible="false"/>
                  </div>
                      </div>
 ...
 <asp:TemplateField HeaderText=" CUMULATIVE LAND IMAGES UPLOADED" ItemStyle-Width = "150" HeaderStyle-ForeColor="White" HeaderStyle-CssClass="header-center">
         ...
         <asp:LinkButton ID="LinkButtonmand" runat="server" Font-Bold="True" ForeColor="Red"  Font-Underline="true" CommandName="MyUpdate" CommandArgument='<%#Eval("MANDAL")+","+ "NOTHAVING"%> ' CausesValidation="false"   OnClick="mandclick_Click" ><%# Eval("Not_having_Land_Image") %></asp:LinkButton>
            </ItemTemplate>
        </asp:TemplateField>
 ...
 <asp:TemplateField HeaderText="Father Name" ItemStyle-Width = "150" HeaderStyle-ForeColor="White" HeaderStyle-CssClass="header-center">
           ...
           <asp:GridView ID="GridView6" runat="server" AutoGenerateColumns="False"   class="grid"
                    BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px"   
                    CellPadding="4" > 
                    <Columns>  
 ...
 <asp:TemplateField HeaderText="Father Name" ItemStyle-Width = "150" HeaderStyle-ForeColor="White" HeaderStyle-CssClass="header-center">
    ...
    <div class="row justify-content-center" style="text-align:right" id="divMandcount" runat="server">
       ...
       <div class="headertable">
      <asp:GridView ID="GridView7" runat="server" AutoGenerateColumns="False"  class="grid" 
                    BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px"   
                    CellPadding="4" > 
                    <Columns>   
