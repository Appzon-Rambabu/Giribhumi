<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ROFR_MASTER.Master" AutoEventWireup="true" CodeBehind="TemplateforCropLoans.aspx.cs" Inherits="ROFR.pages.TemplateforCropLoans" EnableEventValidation="false" %>
                    ...
                    <asp:TextBox ID="txt_mid" runat="server" Text='<%# Eval("Id") %>' CssClass="form-control" Visible="false"></asp:TextBox>
                      ...
                      <div class="row mb-2">
                         ...
                         <div class="row mb-2">
                          ...
                          <div class="col-md-6">
                              <asp:TextBox ID="txt_adhar" runat="server"  CssClass="form-control" autocomplete="off" onkeypress='codevalidate(event)'  MaxLength="16" ></asp:TextBox></div>
                       ...
                       <div class="row mb-2">
                          ...
                          <div class="col-md-6">
                              <asp:TextBox ID="txt_bname" runat="server"  CssClass="form-control" onkeypress='Accountnovalidate(event)'></asp:TextBox></div>
                         
                      </div>
                      <div class="row mb-2">
                          <asp:Label ID="lbl_IFSC" runat="server" Text="IFSC CODE" class="col-md-4 col-form-label"></asp:Label><span style="color: Red;">*</span>
                          <div class="col-md-6">
                              <asp:TextBox ID="txt_ifsc_code" runat="server"  CssClass="form-control" onkeypress='Accountnovalidate(event)'></asp:TextBox></div>
                       ...
                       <div class="row mb-2">
                        ...
                        <div class="row mb-2">
                          ...
                          <div class="col-md-6">
                              <asp:TextBox ID="txt_fr" runat="server"  CssClass="form-control" onkeypress='Accountnovalidate(event)'></asp:TextBox></div>
                        ...
                        <div class="row mb-2">
                          ...
                          <div class="col-md-6">
                              ...
                              <asp:TextBox ID="txt_revillage" runat="server" CssClass="form-control" onkeypress='Accountnovalidate(event)' ></asp:TextBox></div>
                      </div>
                       <div class="row mb-2">
                      ...
                      <div class="row mb-2">
                       ...
                       <div class="row mb-2">
                          ...
                          <div class="col-md-6">
                              ...
                              <asp:TextBox ID="txt_accno" runat="server" CssClass="form-control" onkeypress='Accountnovalidate(event)'></asp:TextBox></div>
                      </div>
                        <div class="row mb-2">
                       ...
                       <div class="row mb-2">
                          ...
                          <div class="col-md-6">
                              ...
                              <asp:TextBox ID="txt_fd" runat="server" CssClass="form-control" onkeypress='Accountnovalidate(event)'></asp:TextBox></div>
                      </div>
                       <div class="row mb-2">
                          ...
                          <div class="col-md-6">
                              ...
                              <asp:TextBox ID="txt_fbeat" runat="server" CssClass="form-control" onkeypress='Accountnovalidate(event)'></asp:TextBox></div>
                      </div>
                       <div class="row mb-2">
                        ...
                        <div class="row mb-2">
                          ...
                          <div class="col-md-6">
                              ...
                              <asp:TextBox ID="txt_ext" runat="server" CssClass="form-control" onkeypress='Accountnovalidate(event)' ></asp:TextBox></div>
                      </div>
                       <div class="row mb-2">
