<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ROFR_MASTER.Master" AutoEventWireup="true" CodeBehind="Update_LtrCases.aspx.cs" Inherits="ROFR.pages.Update_LtrCases"  EnableEventValidation="false"%>
...
.headertable table { border-collapse: collapse; width: 100%; border:1px solid #808080 !important;font-size:13px;}
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      <div class="panel panel-body">
        <h5 class="text-center text-success mb-4">VIEW LTR CASE STATUS</h5>
