<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ROFR_MASTER.Master" AutoEventWireup="true" CodeBehind="RPayment_Success.aspx.cs" Inherits="ROFR.pages.RPayment_Success" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
       <div class="panel panel-body"> 
         ...
         <div class="row mb-1 mt-1 justify-content-end">
               ...
               <div class="col-md-4"> 
			   <h5 class="text-center text-success mb-1 mt-1 thick" id="Title_Header">RYTHU BHAROSA PAYMENT SUCCESS DETAILS 2019</h5>
			   </div>
  ...
  <div class="row justify-content-center" style="text-align:right">
      ...
      <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"   class="grid" 
            ...
            <ItemTemplate>
                <div style="text-align:right">
              <asp:Label Class="txt"  ID="lbl1" runat="server"  Text='<%# Eval("benficiary_id") %>' ForeColor="Blue"></asp:Label>
