...
{
    public partial class Phase1_Data : System.Web.UI.Page
    {
        ...
        protected void Phase1_Download(object sender, EventArgs e)
        {

            BindData();
        }
        protected void Phase2_Download(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                DataTable dt = ProjectRofrBAL.GetMasterDetails.Phase1_Phase2_data("Phase2", "", "", "", "", (string)(Session["username"]), (string)Session["userprevilages"]);
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    string filename = "Phase2_Data.xls";
                    System.IO.StringWriter tw = new System.IO.StringWriter();
                    System.Web.UI.HtmlTextWriter hw = new System.Web.UI.HtmlTextWriter(tw);
                    DataGrid dgGrid = new DataGrid();
                    dgGrid.DataSource = dt;
