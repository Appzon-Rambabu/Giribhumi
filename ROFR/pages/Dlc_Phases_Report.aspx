<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ROFR_MASTER.Master" AutoEventWireup="true" CodeBehind="Dlc_Phases_Report.aspx.cs" Inherits="ROFR.pages.Dlc_Phases_Report" EnableEventValidation ="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row mb-1 mt-1 justify-content-end">
               ...
               <div class="col-md-4"> <h5 class="text-center text-success mb-1 mt-1">DLC PHASES REPORT</h5></div>
 ...
 <asp:TemplateField HeaderText="DLC UPLOADED" ItemStyle-Width = "150" HeaderStyle-ForeColor="White" HeaderStyle-CssClass="header-center">
            ...
            <ItemTemplate>
              ...
              <asp:LinkButton ID="lbl3Buttonmand" runat="server" Font-Bold="True" ForeColor="Red"  Font-Underline="true" CommandName="MyUpdate" CommandArgument='<%#Eval("mandal")+","+ "Not Having Dlc"%> ' CausesValidation="false" OnClick="MandalLevel_OnClick" ><%# Eval("Not_Having_Dlc") %></asp:LinkButton>
    ...
    <div class="row justify-content-center" style="text-align:right" id="div_village" runat="server">
      ...
      <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False"   
            ...
            <ItemTemplate>
              ...
              <asp:TemplateField HeaderText="HAVING DLC" ItemStyle-Width="150" HeaderStyle-ForeColor="White" HeaderStyle-CssClass="header-center">
                  <ItemTemplate>
                      <asp:Label ID="lbl2" ForeColor="Red" Font-Bold="true" Text='<%# Eval("Having_Dlc") %>' runat="server" Visible="false"></asp:Label>
