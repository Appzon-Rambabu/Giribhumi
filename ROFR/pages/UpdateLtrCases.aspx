<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Land_reg_TranMaster.master" AutoEventWireup="true" CodeBehind="UpdateLtrCases.aspx.cs" Inherits="ROFR.pages.UpdateLtrCases" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    OnRowEditing="EditCases" OnRowDataBound="RowDataBound" OnRowUpdating="UpdateCases" CssClass="table-grid"
      ...
      <%--  <asp:CommandField ShowEditButton="True"  />--%>
       ...
       <%--  <asp:TemplateField ControlStyle-CssClass="min-100">  
              ...
              <FooterStyle BackColor="#99CCCC" ForeColor="#003399" />
                            <HeaderStyle BackColor="#fff" Font-Bold="True" ForeColor="#CCCCFF" />
