<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ROFR_MASTER.Master" AutoEventWireup="true" CodeBehind="Revenuewise_Loan_reports.aspx.cs" Inherits="ROFR.pages.Revenuewise_Loan_reports" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      <div class="panel panel-body" style="margin-top:150px;"> 
         ...
         <div class="row mb-1 mt-1 justify-content-end">
               ...
               <div class="col-md-4"> <h5 class="text-center text-success mb-1 mt-1">REVENUE WISE LOAN REPORT</h5></div>
    ...
    <div class="row justify-content-center" style="text-align:right">
      ...
      <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"   
            ...
            <ItemTemplate>
              ...
              <asp:Label Class="txt"  ID="lbl0" runat="server"  Font-Bold="True" Text='<%# Eval("ITDA_NAME") %>' Visible="false"></asp:Label>
                     <asp:LinkButton ID="LinkButton0" runat="server" Font-Bold="True" ForeColor="Red"  Font-Underline="true" CommandName="MyUpdate" CommandArgument='<%#Eval("ITDA_NAME")+","+ "rdist"%>' CausesValidation="false"  OnClick="Getlink_Click" ><%# Eval("ITDA_NAME") %></asp:LinkButton>
      ...
      <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False"   
            ...
            <ItemTemplate>
                <div style="text-align:left">
              <asp:Label Class="txt"  ID="lbld0" runat="server"  Font-Bold="True" Text='<%# Eval("DISTRICT") %>' Visible="false"></asp:Label>
                     <asp:LinkButton ID="LinkDButton0" runat="server" Font-Bold="True" ForeColor="Red"  Font-Underline="true" CommandName="MyUpdate" CommandArgument='<%#Eval("DISTRICT")+","+ "rmandal"%>' CausesValidation="false"  OnClick="Getlink_Click" ><%# Eval("DISTRICT") %></asp:LinkButton>
      ...
      <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False"   
            ...
            <ItemTemplate>
              ...
              <asp:Label Class="txt"  ID="lbl0" runat="server"  Font-Bold="True" Text='<%# Eval("MANDAL") %>' Visible="false"></asp:Label>
                     <asp:LinkButton ID="LinkButton0" runat="server" Font-Bold="True" ForeColor="Red"  Font-Underline="true" CommandName="MyUpdate" CommandArgument='<%#Eval("MANDAL")+","+ "rvillage"%>' CausesValidation="false"  OnClick="Getlink_Click" ><%# Eval("MANDAL") %></asp:LinkButton>
      ...
      <asp:GridView ID="GridView4" runat="server" AutoGenerateColumns="False"   
            ...
            <ItemTemplate>
                <div style="text-align:left">
              <asp:Label Class="txt"  ID="lbl0" runat="server"  Font-Bold="True" Text='<%# Eval("VILLAGE") %>' ></asp:Label>
   ...
   <asp:LinkButton ID="LinkButton1" runat="server" Font-Bold="True" ForeColor="Red"  Font-Underline="true" CommandName="MyUpdate" CommandArgument='<%#Eval("VILLAGE")+","+ "RENTERED"%>' CausesValidation="false"  OnClick="Getlink_Click" ><%# Eval("LOANS_ENTERED") %></asp:LinkButton>
            </ItemTemplate>
        </asp:TemplateField>
                          <asp:TemplateField HeaderText="LOANS APPROVED" ItemStyle-Width = "150" HeaderStyle-ForeColor="White" HeaderStyle-CssClass="header-center">
            <ItemTemplate>
                <asp:Label ID="lbl2" ForeColor="Black" Font-Bold="True" Text='<%# Eval("LOANS_APPROVED") %>' runat="server"  Visible="false"/>
  <asp:LinkButton ID="LinkButton2" runat="server" Font-Bold="True" ForeColor="Red"  Font-Underline="true" CommandName="MyUpdate" CommandArgument='<%#Eval("VILLAGE")+","+ "RAPPROVED"%>' CausesValidation="false"  OnClick="Getlink_Click" ><%# Eval("LOANS_APPROVED") %></asp:LinkButton>
            </ItemTemplate>
        </asp:TemplateField> 
         ...
         <asp:LinkButton ID="LinkButton3" runat="server" Font-Bold="True" ForeColor="Red"  Font-Underline="true" CommandName="MyUpdate" CommandArgument='<%#Eval("VILLAGE")+","+ "RRELEASED"%>' CausesValidation="false"  OnClick="Getlink_Click" ><%# Eval("LOANS_RELEASED") %></asp:LinkButton>
            </ItemTemplate>
        </asp:TemplateField> 
