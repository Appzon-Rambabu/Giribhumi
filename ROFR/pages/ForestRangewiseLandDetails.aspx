<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/HOME.Master" AutoEventWireup="true"  EnableEventValidation="false" CodeBehind="ForestRangewiseLandDetails.aspx.cs" Inherits="ROFR.pages.ForestRangewiseLandDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="content-area">
          ...
          <div class="row mb-2">
              <div class="col-md-10">
                  <h5 class="text-center text-success mb-2 mt-3 offset-2">FOREST RANGE WISE LAND SUMMARY REPORT</h5>
              </div>
              <div class="col-md-2">
           ...
           <div class="row mb-4">
                ...
                <div class="row  d-flex justify-content-center" id="Div1" runat="server">
                    <div class="col-md-6 text-center pl-0 pr-0">
                        <asp:Label ID="txt_Itda" runat="server" Text="Division Name:"></asp:Label>&nbsp<asp:Label ID="Label7" runat="server" Text="*" ForeColor="Red"></asp:Label>
                    </div>
    ...
    <div class="row" style="text-align:right">
     ...
     <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"   
            ...
            <ItemTemplate>
                <div style="text-align:left">
                      <asp:LinkButton ID="LinkButton1" runat="server" Font-Bold="True" ForeColor="Red" Font-Underline="true"    CommandName="MyUpdate" CommandArgument='<%#Eval("Forest_Range")+","+ "1"%>' CausesValidation="false"   OnClick="link_onclick" ><%# Eval("Forest_Range") %></asp:LinkButton>
                    <asp:Label ID="lbl1"  Font-Bold="True" Text='<%# Eval("Forest_Range") %>' runat="server" Visible="false" />
                </div>
            </ItemTemplate>
        </asp:TemplateField>
