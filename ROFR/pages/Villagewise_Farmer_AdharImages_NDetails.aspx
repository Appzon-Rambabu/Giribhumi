<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ROFR_MASTER.Master" AutoEventWireup="true" CodeBehind="Villagewise_Farmer_AdharImages_NDetails.aspx.cs" Inherits="ROFR.pages.Villagewise_Farmer_AdharImages_NDetails"  EnableEventValidation="false"%>
      ...
      <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"   > 
            ...
            <ItemTemplate>
                    ...
                    <asp:Image ID="Image1" runat="server"  ImageUrl='<%# "data:image/jpg;base64," + Convert.ToBase64String((byte[])Eval("Image")) %>' Width="50px" Height="50px"/>
                         ...
                         <asp:TemplateField HeaderText="Farmer Image from Aadhar" HeaderStyle-ForeColor="White" HeaderStyle-CssClass="header-center">
            <ItemTemplate>
                 
                    <asp:Image ID="AImage" runat="server"  ImageUrl='<%# "data:image/jpg;base64," + Convert.ToBase64String((byte[])Eval("AImage")) %>' Width="50px" Height="50px"/>
