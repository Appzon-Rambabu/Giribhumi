<%@ Page Title="Mandal Master Details" Language="C#" MasterPageFile="~/Masters/ROFR_MASTER.Master" AutoEventWireup="true" CodeBehind="Mandal_Master.aspx.cs" Inherits="ROFR.pages.Mandal_Master"  EnableEventValidation="false"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <thead>
    <tr>
      <h5 class="text-center text-success">Revenue Mandal - Forest Range Master</h5>
    </tr>
  </thead>
  <tbody>
    <tr>
           ...
           <table class="table table-bordered table-striped" border="0" cellpadding="0" cellspacing="0" width="100%">
            ...
            <table id="gvMain" style=" border-collapse: collapse;" align="center" border="1" bordercolor="lightgrey">
                    ...
                    <th style="text-align: center" >LGD DISTRICT  CODE<br />(2)</th> 
                        ...
                        <th style="text-align: center" >FOREST DIVISION CODE<br />(6)</th>   
                            <th style="text-align: center" > FOREST DIVISION NAME <br />(7)</th> 
                             <th style="text-align: center" >FOREST RANGE CODE<br />(8)</th> 
                             <th style="text-align: center" >FOREST RANGE NAME<br />(9)</th> 
