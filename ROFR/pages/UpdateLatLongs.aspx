<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ROFR_MASTER.Master" AutoEventWireup="true" CodeBehind="UpdateLatLongs.aspx.cs" Inherits="ROFR.pages.UpdateLatLongs" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <ItemTemplate>
        <asp:Label Text='<%# Eval("L_ID") %>' runat="server" ID="LblCusomerName" />
    </ItemTemplate>
</asp:TemplateField>
        ...
        <asp:RequiredFieldValidator ID="vstorid" runat="server" ControlToValidate="instorid" Text="?" ValidationGroup="validaiton"/>
                                        ...
                                        <asp:TemplateField HeaderText="LONGITUDE" ItemStyle-Width="250">
                                            <ItemTemplate>
