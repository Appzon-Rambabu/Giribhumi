<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Land_reg_TranMaster.master" AutoEventWireup="true" CodeBehind="LAND_TRANSFER_REGULATION.aspx.cs" Inherits="ROFR.pages.LAND_TRANSFER_REGULATION"  EnableEventValidation="false" %>
...
<%--          <div class="col-md-12 text-right" id="div3" runat="server">
             <asp:LinkButton ID="LinkButton1"  Font-Bold="True"  ForeColor="#009900" Font-Underline="True" runat="server" OnClick="link_onclick" >VIEW LAND TRANSFER REGULATIONS</asp:LinkButton></div>--%>
        ...
        <div class="card border border-success bg-light-green" id="div_getdetails" runat="server">
            <div class="card-body aadhar-details">
                 ...
                 <div class="row mb-2">
                    <div class="col-md-12 text-left" id="div5" runat="server"><span style="color: red">Fields marked as * are mandatory</span></div>
                    <br />
                    <br />
                    <div class="col-md-4">
 ...
 <asp:DropDownList ID="ddl_mandal" runat="server" CssClass="form-control" OnSelectedIndexChanged="ddl_mandal_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                    ...
                    <div class="col-md-4">
                     ...
                     <div class="col-md-4">
                        <div class="row  d-flex justify-content-center" id="Div17" runat="server">
                            ...
                            <div class="col-md-6 value">
                                <asp:DropDownList ID="ddl_hab" runat="server" CssClass="form-control" AutoPostBack="true"></asp:DropDownList>
                ...
                <div class="row mt-2 mb-2 text-left">
                    ...
                    <div class="col-md-2 title"><asp:Label ID="Label5" runat="server" Text="Petition:"></asp:Label><%--<span style="color: red">*</span>--%></div>
                ...
                <div class="row text-left" id="div_sdc" runat="server">
                    <div class="col-md-2 title"><asp:Label ID="Lbl_sdc" runat="server" Text="Orders Passed in whose Favour:"></asp:Label><%--<span style="color: red">*</span>--%></div>
