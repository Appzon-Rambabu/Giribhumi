<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ROFR_MASTER.Master" AutoEventWireup="true" CodeBehind="Twd_Comments_July2021_Category_Report.aspx.cs" Inherits="ROFR.pages.Twd_Comments_July2021_Category_Report" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="panel panel-body"  style="margin-top:150px;">
       ...
       <div class="headertable">
        ...
        <table border="1">
             <tr >
                  <th align="center" colspan="13" style="text-align:center;background-color: #2e44df;color: white;"><asp:Label ID="lbl_remarks" runat="server" Text=""></asp:Label>/th>
          ...
          <tr class="aftr">
					...
					<th  style="text-align: center; vertical-align: middle;background-color: #2e44df;color: white;min-width: 90px;">LAND TO IDENTIFIED</th>
					<th  style="text-align: center; vertical-align: middle;background-color: #2e44df;color: white;min-width: 90px;">POLAVARAM SUBMERGED</th>
					<th  style="text-align: center; vertical-align: middle;background-color: #2e44df;color: white;min-width: 90px;">DEATH CASES</th>
                    <th  style="text-align: center; vertical-align: middle;background-color: #2e44df;color: white;min-width: 90px;">NON TRIBES </th>
					<th  style="text-align: center; vertical-align: middle;background-color: #2e44df;color: white;min-width: 90px;">GOVT EMPLOYEE</th>
					<th  style="text-align: center; vertical-align: middle;background-color: #2e44df;color: white;min-width: 90px;">HAVING LAND -NOT UPDATE WEBLAND</th>
					<th  style="text-align: center; vertical-align: middle;background-color: #2e44df;color: white;min-width: 90px;">HAVING LAND -NOT UPDATE GIRIBHUMI</th>

              <th  style="text-align: center; vertical-align: middle;background-color: #2e44df;color: white;min-width: 90px;">HAVING LAND - MUTATION TO BE DONE</th>
              <th  style="text-align: center; vertical-align: middle;background-color: #2e44df;color: white;min-width: 90px;">NOT DEPEND CULTIVATION</th>
              <th  style="text-align: center; vertical-align: middle;background-color: #2e44df;color: white;min-width: 90px;">MIGRATED</th>
          </tr>
    ...
    <FooterTemplate>
      ...
      <asp:Repeater ID="Rpt_cmts_detail" runat="server"  OnItemDataBound="Rpt_cmts_detail_ItemDataBound">
                 <HeaderTemplate>
        <table border="1" >
              <tr ><th align="center" colspan="18" style="text-align:center;background-color: #2e44df;color: white;"><asp:Label ID="lbl_cmtsitdaa" runat="server" Text=""></asp:Label></th>
             
              </tr>
             <tr class="aftr" ><th align="center" colspan="18" style="text-align:center;background-color: #2e44df;color: white;"><asp:Label ID="cmtsstatus" runat="server" Text=""></asp:Label></th>
                 <%-- <th align="center" colspan="2" style="text-align:center;background-color: #2e44df;color: white;">Updated</th>
                  <th align="center" colspan="2" style="text-align:center;background-color: #2e44df;color: white;">Pending</th>
                  <th align="center" colspan="9" style="text-align:center;background-color: #2e44df;color: white;">Noland</th>
                  <th align="center" colspan="9" style="text-align:center;background-color: #2e44df;color: white;">Lessthan 1 Acre</th>
                    <th align="center" colspan="9" style="text-align:center;background-color: #2e44df;color: white;">Greaterthan 1 Acre</th>--%>
              </tr>
             <tr class="aftr" ><th align="center" colspan="18" style="text-align:center;background-color: #2e44df;color: white;"><asp:Label ID="cmtsremarks" runat="server" Text=""></asp:Label></th>
          ...
          <tr class="aftr">
					...
					<th  style="text-align: center; vertical-align: middle;background-color: #2e44df;color: white;min-width: 90px;">ROFR Dynamic</th>
					<th  style="text-align: center; vertical-align: middle;background-color: #2e44df;color: white;min-width: 90px;">ROFR Extent</th>
              <th  style="text-align: center; vertical-align: middle;background-color: #2e44df;color: white;min-width: 90px;">SURVEY/COMPARTMENT/NO.</th>
                            <th  style="text-align: center; vertical-align: middle;background-color: #2e44df;color: white;min-width: 90px;">KHATHA/PATTA/NO.</th>
               <th  style="text-align: center; vertical-align: middle;background-color: #2e44df;color: white;min-width: 90px;">EXTENT</th>
              <th  style="text-align: center; vertical-align: middle;background-color: #2e44df;color: white;min-width: 90px;">RN</th>
					<th  style="text-align: center; vertical-align: middle;background-color: #2e44df;color: white;min-width: 90px;">Land Holding Remarks</th>
          </tr>
