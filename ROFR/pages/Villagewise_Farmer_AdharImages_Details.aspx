<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ROFR_MASTER.Master" AutoEventWireup="true" CodeBehind="Villagewise_Farmer_AdharImages_Details.aspx.cs" Inherits="ROFR.pages.Villagewise_Farmer_AdharImages_Details" EnableEventValidation="false" %>
  ...
  <div class="row justify-content-center" style="text-align:center">
      ...
      <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"   > 
            ...
            <ItemTemplate>
                    ...
                    <asp:Image ID="Image1" runat="server"  ImageUrl='<%# "data:image/jpg;base64," + Convert.ToBase64String((byte[])Eval("AImage")) %>' Width="50px" Height="50px"/>
