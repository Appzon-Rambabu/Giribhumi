<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/HOME.Master" AutoEventWireup="true" CodeBehind="Compartments_In_Mandals.aspx.cs" Inherits="ROFR.pages.Compartments_In_Mandals" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel panel-body" style="margin-top:80px;"> 
          ...
          <div class="row mb-2">
              <div class="col-md-10">
                  <h5 class="text-center text-success mb-2 mt-3 offset-2">COMPARTMENT COVERED IN TWO MANDALS</h5>
              </div>
              <div class="col-md-2">
