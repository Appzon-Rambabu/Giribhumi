<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ROFR_MASTER.Master" AutoEventWireup="true" CodeBehind="MandalWise_Rythubarosa.aspx.cs" Inherits="ROFR.pages.MandalWise_Rythubarosa" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="panel panel-body"> 
         ...
         <div class="row mb-1 mt-1 justify-content-end">
               ...
               <div class="col-md-4"> <h5 class="text-center text-success mb-1 mt-1 thick" id="Title_Header">MANDAL WISE RYTHU BHAROSA PAYMENT STATUS 2019</h5></div>
  ...
  <div class="row justify-content-center" style="text-align:right">
      ...
      <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"   class="grid" 
            ...
            <ItemTemplate>
                 <asp:Label ID="lbl2" ForeColor="Red" Font-Bold="True" Text='<%# Eval("Payment_Rejected") %>' runat="server" />
