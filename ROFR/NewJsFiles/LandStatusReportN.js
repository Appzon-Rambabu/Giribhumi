...
function Get_Districts(val) {
    ...
    $.ajax({
        ...
        url: '../Giribhumi/GetLandstatus_report',
        data: "{ 'type':'Land'}",
        dataType: "json",
                    ...
                    buttons: [
                        {
                            ...
                            messageTop: function () {
                                ...
                                if (printCounter === 1) {
                                    ...
                                    return 'Plot Wise Land Status Report District wise';
                        ...
                        {
                            extend: 'excelHtml5',
                            title: 'Plot Wise Land Status Report District wise',
...
function Get_Mandals(data) {
    ...
    $.ajax({
        ...
        contentType: 'application/json; charset=utf-8',
        url: '../Giribhumi/GetLandstatus_report',
        data: "{ 'type':'PMandal','Itda':'" + data.ITDA_NAME + "','District':'" + data.DISTRICT + "'}",
        dataType: "json",
                    ...
                    buttons: [
                        {
                            ...
                            messageTop: function () {
                                ...
                                if (printCounter === 1) {
                                    ...
                                    return 'Mandal wise Plot Wise Land Status Report';
                        ...
                        {
                            extend: 'excelHtml5',
                            title: ' Mandal wise Plot Wise Land Status Report',
                            text: '<i class="far fa-file-excel fa-lg" style="width:30px"></i>'
                        },
                        {
                            extend: 'csvHtml5',
                            title: 'Mandal wise Land Status Report ',
                            text: '<i class="fas fa-file-csv fa-lg" style="width:30px"></i>',
                        },
                        {
                            extend: 'print',
                            ...
                            messageTop: function () {
                                ...
                                if (printCounter === 1) {
                                    return 'Mandal wise Land Status Report';
                                }
                                else {
                                    return 'You have printed this document ' + printCounter + ' times';
                                }
