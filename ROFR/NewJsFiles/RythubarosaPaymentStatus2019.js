...
function Get_Districts(val) {
    ...
    var printCounter = 0;
        ...
        $.ajax({
            ...
            url: '../Giribhumi/GetRythubharosaPaymentstatus_report',
                        ...
                        buttons:([
                            {
                                ...
                                messageTop: function () {
                                    ...
                                    if (printCounter === 1) {
                                        return 'DISTRICT WISE RYTHUBAROSA PAYMENT STATU-2019';
                                    }
                                },
                                messageBottom: null
                            },
                            {
                                extend: 'excelHtml5',
                                title: 'DISTRICT WISE RYTHUBAROSA PAYMENT STATU-2019',
...
function Get_Mandal(dataa) {
    
    sessionStorage.setItem('itdaname', dataa.ITDA_NAME);
    sessionStorage.setItem('districtname', dataa.District);
    $('#itdaval1').text(dataa.ITDA_NAME);
    $('#distval1').text(dataa.District);
    //All hide here
    $('#dt_dist_tbl').hide();
    $('#dt_dist_tbl_wrapper').hide();
    $('#dt_dist_tbl_filter').hide();
    ...
    $.ajax({
        ...
        contentType: 'application/json; charset=utf-8',
        url: '../Giribhumi/GetRythubharosaPaymentstatus_report',
        data: "{ 'type':'Mandal','District':'" + dataa.District + "','Itda':'" + dataa.ITDA_NAME + "'}",
        dataType: "json",
        success: function (response) {
                    ...
                    buttons: [
                        {
                            ...
                            messageTop: function () {
                                ...
                                if (printCounter === 1) {
                                    return 'MANDAL WISE RYTHUBAROSA PAYMENT STATU-2019';
                                }
                            },
                            messageBottom: null
                        },
                        {
                            extend: 'excelHtml5',
                            title: 'MANDAL WISE RYTHUBAROSA PAYMENT STATU-2019',
                            text: '<i class="far fa-file-excel fa-lg" style="width:30px"></i>'
                        },
                        {
                            extend: 'csvHtml5',
                    ...
                    buttons: [
                        {
                            ...
                            messageTop: function () {
                                ...
                                if (printCounter === 1) {
                                    return 'VILLAGE WISE RYTHUBAROSA PAYMENT STATU-2019';
                                }
                            },
                            messageBottom: null
                        },
                        {
                            extend: 'excelHtml5',
                            title: 'VILLAGE WISE RYTHUBAROSA PAYMENT STATU-2019',
                            text: '<i class="far fa-file-excel fa-lg" style="width:30px"></i>'
                        },
                        {
                            extend: 'csvHtml5',
            ...
            if (response.Status == "1") {
                ...
                $('#dt_RPayment_Success_tbl').DataTable({
                    ...
                    buttons: [
                        {
                            extend: 'copy',
                            text: '<i class="far fa-copy fa-lg"></i>',
                            messageTop: function () {
                                printCounter++;

                                if (printCounter === 1) {
                                    return 'SUCCESS WISE RYTHUBAROSA PAYMENT STATU-2019';
                                }
                            },
                            messageBottom: null
                        },
                        {
                            extend: 'excelHtml5',
                            title: 'SUCCESS WISE RYTHUBAROSA PAYMENT STATU-2019',
                            text: '<i class="far fa-file-excel fa-lg" style="width:30px"></i>'
                        },
                        {
                            extend: 'csvHtml5',
                    ...
                    buttons: [
                        {
                            ...
                            messageTop: function () {
                                ...
                                if (printCounter === 1) {
                                    return 'REJECTED WISE RYTHUBAROSA PAYMENT STATU-2019';
                                }
                            },
                            messageBottom: null
                        },
                        {
                            extend: 'excelHtml5',
                            title: 'REJECTED WISE RYTHUBAROSA PAYMENT STATU-2019',
                            text: '<i class="far fa-file-excel fa-lg" style="width:30px"></i>'
                        },
                        {
                            extend: 'csvHtml5',
