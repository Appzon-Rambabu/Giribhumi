<%@ Page Title="" Language="C#" MasterPageFile="~/Loans/Loans.Master" AutoEventWireup="true" CodeBehind="LoanReleasedList.aspx.cs" Inherits="ROFR.Loans.LoanReleasedList" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Loan Released List</title>
    <script src="JSControllers/LoanReleasedList.js"></script>
</asp:Content>
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header bg-indigo py-1">
                                <h5 class="card-title text-center text-uppercase">Loan Released List</h5>
                            </div>
                                    ...
                                    <table class="table table-bordered mb-3" style="max-height:300px;table-layout:fixed;">
                                        ...
                                        <tbody style="text-align:center">
                                            <tr data-ng-repeat="par in ReportsTable">
                                                ...
                                                <td>  {{par.CHARGE_RELEASE_APPROVED_ON}} </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
