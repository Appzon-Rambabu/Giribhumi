<%@ Page Title="" Language="C#" MasterPageFile="~/Loans/Loans.Master" AutoEventWireup="true" CodeBehind="BranchUserUpdation.aspx.cs" Inherits="ROFR.Loans.BranchUserUpdation" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Branch User Updation</title>
    <script src="JSControllers/BranchUserUpdation.js"></script>
</asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="page-content" ng-controller="BranchUserUpdation">
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-header bg-indigo py-1">
                                <h5 class="card-title text-center text-uppercase">Branch User Updation</h5>
                            </div>
                            <div class="card-body pb-5">
                                ...
                                <div class="mt-3 text-center">
                                    ...
                                    <button type="button" class="btn btn-success" ng-hide="isactive" ng-click="UserUpdate('Active');">Activate</button>
                                    <button type="button" class="btn btn-success" ng-show="isactive" ng-click="UserUpdate('Inactive');">Inactive</button>
