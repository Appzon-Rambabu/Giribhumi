<%@ Page Title="" Language="C#" MasterPageFile="~/Loans/Loans.Master" AutoEventWireup="true" CodeBehind="LoanCreation.aspx.cs" Inherits="ROFR.Loans.LoanCreation" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Loan Information Creation</title>
    <script src="JSControllers/LoanCreation.js"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="page-content" ng-controller="LoanCreation">
                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-header bg-indigo py-1">
                                    <h5 class="card-title text-center text-uppercase">Loan Information Creation</h5>
                                </div>
                                        ...
                                        <table class="table table-bordered mb-1" style="max-height: 300px;">
                                            ...
                                            <tbody style="text-align: center">
                                                <tr data-ng-repeat="par in PattadarTable">
                                                    <td><a style="text-decoration: underline; cursor: pointer;" ng-click="GetPattadarDetails(par.ID);">Select</a></td>
                                    ...
                                    <div>
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="form-group row mb-3">
                                                ...
                                                <!--<div class="col-md-3">
                                                <label class="col-lg-12 col-form-label">Market Value :</label>
                                                <input type="text" data-ng-model="selEDR" class="form-control">
                                            </div>
                                            <div class="col-md-3">
                                                <label class="col-lg-12 col-form-label">Partial Extent :</label>
                                                <input type="text" data-ng-model="selEDR" class="form-control">
                                            </div>-->
                                            </div>
                                        ...
                                        <fieldset>
                                            ...
                                            <div class="form-group row mb-3">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <div>
                                                        <input type="text" class="form-control" ng-model="LOAN_ACCOUNTNO">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <label class="col-form-label">Saving Bank Account No :</label>
                                                    <div>
                                                        <input type="text" alpha-numbers maxlength="50" class="form-control" ng-model="SAVING_BANKACCOUNTNO">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <div>
                                                        <input type="text" alpha-bets ng-model="BORROWER_NAME" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <label class="col-form-label">Father/Husband's Name : <span style="color: red">* </span></label>
                                                    <div>
                                                        <input type="text" alpha-bets ng-model="FATHER_HUSBAND_NAME" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <label class="col-form-label">Borrower Aadhar Number :</label>
                                                    <input type="text" numbers-only maxlength="12" ng-model="BORROWER_AADHAAR_NO" class="form-control">
                                                </div>

                                                <div class="col-md-3">
                                                    <label class="col-lg-12 col-form-label">Crop Season : <span style="color: red">* </span></label>
                                                    <select class="form-control" ng-model="CROP_SEASON">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <select class="form-control" ng-model="NAME_OF_THE_CROP">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <div>
                                                        <input type="text" only-digits ng-model="LOAN_AMMOUNT" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <label class="col-form-label">Subsidy Amount :</label>
                                                    <div>
                                                        <input type="text" only-digits ng-model="SUBSIDY_AMMOUNT" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <label class="col-form-label">Interest Rate : <span style="color: red">* </span></label>
                                                    <input type="text" only-digits ng-model="INTEREST_RATE" class="form-control">
                                                </div>
                                                ...
                                                <div class="col-md-3" ng-show="TYPE_OF_FACILYTY == 'Term Loan'">
                                                    <label class="col-form-label">Term Loan Purpose : <span style="color: red">* </span></label>
