<%@ Page Title="" Language="C#" MasterPageFile="~/Loans/Loans.Master" AutoEventWireup="true" CodeBehind="LoanReleaseEntry.aspx.cs" Inherits="ROFR.Loans.LoanReleaseEntry" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Loan Release Entry</title>
    <script src="JSControllers/LoanReleaseEntry.js"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="page-content" ng-controller="LoanReleaseEntry">
            ...
            <div class="container-fluid">
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header bg-indigo py-1">
                                <h5 class="card-title text-center text-uppercase">Loan Release Entry</h5>
                            </div>
                ...
                <option value="2">Term Loan</option>-->
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="text" maxlength="50" ng-disabled="true"  class="form-control" ng-model="CHARGE_CREATION_APP_ENTRYBY">
                                            </div>

                                            <div class="col-md-3">
                                                <label class="col-form-label">Approved On :</label>
                                                <input type="text" maxlength="50" ng-disabled="true"  class="form-control" ng-model="CHARGE_CREATION_APP_DATE">
                                            </div>

                                            <div class="col-md-3">
                                                <label class="col-form-label">Approval Remarks : <span style="color:red"> * </span></label>
                                                <input type="text" maxlength="50" ng-disabled="true"  class="form-control" ng-model="CHARGE_CREATION_APP_REJ_REMARKS">
                                            </div>

                                            <div class="col-md-3">
                                                <label class="col-form-label">Release Remarks : <span style="color:red"> * </span></label>
                                                <input type="text" maxlength="50"  class="form-control" ng-model="CHARGE_RELEASE_REMARKS">
                                            </div>
                                        </div>
                                    </fieldset>
                                </div>
