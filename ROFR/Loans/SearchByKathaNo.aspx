<%@ Page Title="" Language="C#" MasterPageFile="~/Loans/Loans.Master" AutoEventWireup="true" CodeBehind="SearchByKathaNo.aspx.cs" Inherits="ROFR.Loans.SearchByKathaNo" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Loans Search By Katha No</title>
    <script src="JSControllers/SearchByKathaNo.js"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="page-content" ng-controller="SearchByKathaNo">
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header bg-indigo py-1">
                                <h5 class="card-title text-center text-uppercase">Loans Search By Katha No</h5>
                            </div>
                            <div class="card-body pb-5">
                                ...
                                <div class="form-group row mb-1">
                                    ...
                                    <label class="col-lg-2 col-form-label">Katha No : <span style="color:red"> * </span></label>
                                    <div class="col-lg-2">
                                        <select class="form-control" ng-model="SelKatha">
                                            <option selected="selected" value="">-Select-</option>
                                            <option data-ng-repeat="dis in KathasDD" value="{{dis.KHATHA_NO}}">{{dis.KHATHA_NO}}</option>
                                        </select>
                                    </div>
                                ...
                                <div class="form-group table-wrap">
                                    <table class="table table-bordered mb-1" style="max-height:400px;">
