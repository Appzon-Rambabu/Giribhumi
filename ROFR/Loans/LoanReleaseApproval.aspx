<%@ Page Title="" Language="C#" MasterPageFile="~/Loans/Loans.Master" AutoEventWireup="true" CodeBehind="LoanReleaseApproval.aspx.cs" Inherits="ROFR.Loans.LoanReleaseApproval" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>Loan Release Approval</title>
    <script src="JSControllers/LoanReleaseApproval.js"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="page-content" ng-controller="LoanReleaseApproval">
                    ...
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-header bg-indigo py-1">
                                <h5 class="card-title text-center text-uppercase">Loan Release Approval</h5>
                            </div>
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-group row mb-3">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div>
                                                    <input type="text" ng-disabled="true" alpha-numbers maxlength="50" class="form-control" ng-model="LOAN_ACCOUNTNO">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div>
                                                    <input type="text" ng-disabled="true" alpha-numbers maxlength="50" class="form-control" ng-model="SAVING_BANKACCOUNTNO">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="text" ng-disabled="true" numbers-only maxlength="12" ng-model="BORROWER_AADHAAR_NO" class="form-control">
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <input type="text" ng-disabled="true" only-digits ng-model="INTEREST_RATE" class="form-control">
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <label class="col-form-label">Release Entry By :</label>
                                                <input type="text" maxlength="50" ng-disabled="true" class="form-control" ng-model="CHARGE_RELEASE_BY">
                                            </div>

                                            <div class="col-md-3">
                                                <label class="col-form-label">Release Entry On :</label>
                                                <input type="text" maxlength="50" ng-disabled="true" class="form-control" ng-model="CHARGE_RELEASE_ON">
                                            </div>

                                            <div class="col-md-3">
                                                <label class="col-form-label">Release Remarks : <span style="color:red"> * </span></label>
                                                <input type="text" maxlength="50" ng-disabled="true" class="form-control" ng-model="CHARGE_RELEASE_REMARKS">
                                            </div>

                                            <div class="col-md-3">
                                                <label class="col-form-label">Approval Remarks : <span style="color:red"> * </span></label>
                                                <input type="text" maxlength="500" class="form-control" ng-model="CHARGE_RELEASED_APP_APP_REMARKS">
                                            </div>
                                        </div>
                                    </fieldset>
                                </div>
