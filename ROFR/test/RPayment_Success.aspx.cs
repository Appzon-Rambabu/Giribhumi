...
namespace ROFR.test
{
    public partial class RPayment_Success : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                if (!IsPostBack)
                {
                    if ((string)(Session["CurrentPage"]) == "RPayment_Success.aspx")
                    {
        ...
        protected void BindData(string Itda, string dist, string mandal,string village)
        {
            try
            {
                ...
                DataTable dt = ProjectRofrBAL.GetMasterDetails.GetRythuBharosaStatus("Psuccess", Itda, dist, mandal, village, (string)(Session["username"]), (string)Session["userprevilages"]);
