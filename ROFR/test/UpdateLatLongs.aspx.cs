    ...
    public partial class UpdateLatLongs : System.Web.UI.Page
    {
        ...
        protected void ddlvillage_OnSelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    DataTable dtVillages = MastersDataAnalysisBAL.MastersDataAnalysis.Getbenhabitions(ddl_ITda.SelectedValue, ddl_district.SelectedValue, ddl_mandal.SelectedItem.Text, ddl_Village.SelectedValue);
                    if (dtVillages.Rows.Count > 0)
                    {
                        if (dtVillages.Rows.Count > 0)
                        {
        ...
        protected void ddlhab_OnSelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    DataTable dtVillages = MastersDataAnalysisBAL.MastersDataAnalysis.Getbenpattadhar(ddl_ITda.SelectedValue, ddl_district.SelectedValue, ddl_mandal.SelectedItem.Text, ddl_Village.SelectedValue, ddl_hab.SelectedValue);
                    if (dtVillages.Rows.Count > 0)
                    {
                        if (dtVillages.Rows.Count > 0)
                        {
