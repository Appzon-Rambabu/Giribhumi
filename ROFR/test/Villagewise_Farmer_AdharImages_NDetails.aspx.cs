...
namespace ROFR.test
{
    public partial class Villagewise_Farmer_AdharImages_NDetails : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                if (!IsPostBack)
                {
                    if ((string)(Session["CurrentPage"]) == "Villagewise_Farmer_AdharImages_NDetails.aspx")
                    {
        ...
        protected void BindData(string Itda, string dist, string mandal, string village)
        {
            try
            {
                ...
                DataTable dt = ProjectRofrBAL.GetMasterDetails.GetFarmerImagesReport("AINDetails", Itda, dist, mandal, village, (string)(Session["username"]), (string)Session["userprevilages"]);
