...
namespace ROFR.test
{
    public partial class ROFR_Col_Split : System.Web.UI.Page
    {
        ...
        protected void BindData()
        {
            try
            {
                ...
                else
                {
                    ...
                    if ((string)(Session["CurrentPage"]) == "ROFR_BEATWISE_REPORT.aspx")
                    {
                        Response.Redirect("~//test//ROFR_BEATWISE_REPORT.aspx");
                    }
                    else if ((string)(Session["CurrentPage"]) == "Mee_Giri_Bhoomi.aspx")
                    {
                        Response.Redirect("~//test//Mee_Giri_Bhoomi.aspx");
                    }
                    else if ((string)(Session["CurrentPage"]) == "Data_Analysis.aspx")
                    {
                        Response.Redirect("~//test//Data_Analysis.aspx");
                    }
                }
            }
            catch (Exception ex)
