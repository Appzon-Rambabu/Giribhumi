<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Giribhumi_Master.Master" AutoEventWireup="true" CodeBehind="VillageWise_BeneficiaryMaster_Details.aspx.cs" Inherits="ROFR.test.VillageWise_BeneficiaryMaster_Details"  EnableEventValidation="false"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <div class="panel panel-body" style="margin-top:3px;"> 
         ...
         <div class="row mb-1 mt-1 justify-content-end">
               ...
               <div class="col-md-4"> <h5 class="text-center text-success mb-1 mt-1">VILLAGE WISE FARMER DETAILS</h5></div>
            <div class="col-md-4">
