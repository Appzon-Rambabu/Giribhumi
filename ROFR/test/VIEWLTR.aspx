<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/LANDTRANSFER_MASTER.Master" AutoEventWireup="true" CodeBehind="VIEWLTR.aspx.cs" Inherits="ROFR.test.VIEWLTR"  EnableEventValidation="false"%>
                ...
                <HeaderTemplate>
                    <div class="">
                        ...
                        <table class="table-bordered text-center" style="border-collapse:collapse;">
                            ...
                            <thead>
                                <tr>
                                    <td colspan="2" style="background-color: midnightblue;color:#fff;">&nbsp</td>
                                    <td colspan="12" style="background-color: midnightblue;color:#fff;"></td>
                                    <td colspan="1" style="background-color: midnightblue;color:#fff;">RESPONDENT</td>
                                      <td colspan="2" style="background-color: midnightblue;color:#fff;">PETITIONER</td>
                                    <td colspan="3" style="background-color: midnightblue;color:#fff;">ORDERS IN WHOSE FAVOUR</td>
                                   

                                    <td colspan="2" style="background-color: midnightblue;color:#fff;">ORDERS IMPLEMENTED/AVAILABLE</td>

                                     
                                     
                                      <td colspan="2" style="background-color: midnightblue;color:#fff;">DETAILS OF LAND FOR TRIBAL</td>
                                     
                                  
                                     <td colspan="2" style="background-color: midnightblue;color:#fff;">DETAILS OF LAND FOR GOVERNMENT</td>
                                     

                               
                                     <td colspan="2" style="background-color: midnightblue;color:#fff;"></td>
                                     
                                   
                           
                                </tr>
                                <tr style="background-color: midnightblue;color:#fff;">
