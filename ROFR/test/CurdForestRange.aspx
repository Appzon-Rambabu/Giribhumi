<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Giribhumi_Master.Master" AutoEventWireup="true" CodeBehind="CurdForestRange.aspx.cs" Inherits="ROFR.test.CurdForestRange" EnableEventValidation="false" %>
...
.headertable .aftr th{position: sticky;top: 49x;}
    ...
    <script type="text/javascript">
        function deleteConfirm(pubid) {
            var result = confirm('Do you want to delete Forset Range ?');
            if (result) {
                return true;
            }
            else {
            ...
            <div class="col-md-6">
                ...
                <div class="table-responsive">
                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                <h5 class="text-center text-success">UPDATE FOREST RANGE</h5>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
      ...
      onrowcommand="gridView_RowCommand"
        OnRowDataBound="gridView_RowDataBound">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="FOREST RANGE CODE" HeaderStyle-ForeColor="White" ItemStyle-Width="190">
                                            <ItemTemplate>
                                                <asp:Label ID="lbl_divisioncode" runat="server" ForeColor="Black" Text='<%# Eval("FOREST_RANGE_CODE") %>'></asp:Label>

                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txt_divisioncode" runat="server" Text='<%# Eval("FOREST_RANGE_CODE") %>' onkeypress='codevalidate(event)' Width="180"></asp:TextBox>
                                            </EditItemTemplate>
                                            <FooterTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="FOREST RANGE NAME" HeaderStyle-ForeColor="White" ItemStyle-Width="250">
                                            <ItemTemplate>
                                                <asp:Label ID="lbl_division" runat="server" ForeColor="Black" Text='<%# Eval("FOREST_RANGE_NAME") %>'></asp:Label>

                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txt_division" runat="server" Text='<%# Eval("FOREST_RANGE_NAME") %>' onkeypress='mastervalidatenumerics(event)'></asp:TextBox>
                                            </EditItemTemplate>
                                            <FooterTemplate>
                                ...
                                <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False"
                                    BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" ShowFooter="true"
                                    CellPadding="4" DataKeyNames="FOREST_RANGE_NAME"
                                    onrowcommand="gridView_RowCommand">
                                    <Columns>
                                        <asp:TemplateField HeaderText="FOREST RANGE CODE" HeaderStyle-ForeColor="White" ItemStyle-Width="190">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="FOREST RANGE NAME" HeaderStyle-ForeColor="White" ItemStyle-Width="190">
                                            <ItemTemplate>
                                                <asp:Label ID="lbl_division" runat="server" ForeColor="Black" Text='<%# Eval("FOREST_RANGE_NAME") %>'></asp:Label>
