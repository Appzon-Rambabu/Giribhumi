<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/ROFR_MASTER.Master" AutoEventWireup="true" CodeBehind="Add_Beneficiary_Details.aspx.cs" Inherits="ROFR.test.Add_Beneficiary_Details"  EnableEventValidation="false"%>
     ...
     <div class="container"></div>
         ...
         <div class="panel panel-body">
             <div class="row mt-2 mb-2 justify-content-center">
                 ...
                 <div class="col-md-3 input-group">
                     <span style="color: red">*</span>
                     <asp:DropDownList class="form-control" ID="ddl_district" runat="server" OnSelectedIndexChanged="ddl_district_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                 </div>
