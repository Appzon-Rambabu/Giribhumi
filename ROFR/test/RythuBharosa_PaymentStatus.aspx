<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Giribhumi_Master.Master" AutoEventWireup="true" CodeBehind="RythuBharosa_PaymentStatus.aspx.cs" Inherits="ROFR.test.RythuBharosa_PaymentStatus"  EnableEventValidation="false"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel panel-body" style="margin-top:2px;"> 
         ...
         <div class="row mb-1 mt-1 justify-content-end">
               ...
               <div class="col-md-4"> <h5 class="text-center text-success mb-1 mt-1">DISTRICT WISE RYTHU BHAROSA PAYMENT STATUS</h5></div>
            <div class="col-md-4">
    ...
    <div class="row justify-content-center" style="text-align:right">
      ...
      <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"   
            ...
            <ItemTemplate>
                <asp:Label ID="lbl3" ForeColor="Blue" Font-Bold="True" Text='<%# Eval("Payment_Success") %>' runat="server" />
            ...
            <ItemTemplate>
                 <asp:Label ID="lbl6" ForeColor="Red" Font-Bold="True" Text='<%# Eval("Payment_Rejected") %>' runat="server" />
