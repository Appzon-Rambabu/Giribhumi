<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Giribhumi_Master.Master" AutoEventWireup="true" CodeBehind="VillageWise_BeneficiaryMaster_Abstract.aspx.cs" Inherits="ROFR.test.VillageWise_BeneficiaryMaster_Abstract" EnableEventValidation="false" %>
     ...
     <div class="content-area">
       <div class="panel panel-body" style="margin-top:3px;"> 
         ...
         <div class="row mb-1 mt-1 justify-content-end">
               ...
               <div class="col-md-4"> <h5 class="text-center text-success mb-1 mt-1">VILLAGE WISE FARMER REPORT</h5></div>
            <div class="col-md-4">
    ...
    <div class="row" style="text-align:right">
      ...
      <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"   
            ...
            <ItemTemplate>
              ...
              <asp:Label Class="txt"  ID="lbl0" runat="server"  Font-Bold="True" Text='<%# Eval("Village") %>' Visible="false"></asp:Label>
                    <asp:LinkButton ID="LinkButton0" runat="server" Font-Bold="True" ForeColor="Red" Font-Underline="true"    CommandName="MyUpdate" CommandArgument='<%#Eval("Village")+","+ "1"%>' CausesValidation="false"   OnClick="link_onclick" ><%# Eval("Village") %></asp:LinkButton>
                    </div>
            </ItemTemplate>
        </asp:TemplateField>
            ...
            <ItemTemplate>
                 <asp:Label ID="lbl8" ForeColor="Red" Font-Bold="True" Text='<%# Eval("Adhharnoinvalid") %>' runat="server" />
                        ...
                        <asp:TemplateField HeaderText="No of Farers Having Bank Details (Bank A/c + IFSC Code)" ItemStyle-Width = "150" HeaderStyle-ForeColor="White" HeaderStyle-CssClass="header-center">
            <ItemTemplate>
            ...
            <ItemTemplate>
                 <asp:Label ID="lbl11" ForeColor="Red" Font-Bold="True" Text='<%# Eval("Banknotavaliable") %>' runat="server" />
                          ...
                          <asp:TemplateField HeaderText="No of Farmers Having Inavlid Bank Details (Bank A/c + IFSC Code)" ItemStyle-Width = "150" HeaderStyle-ForeColor="White" HeaderStyle-CssClass="header-center">
            <ItemTemplate>
