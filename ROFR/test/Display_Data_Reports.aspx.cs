...
namespace ROFR.test
{
    public partial class Display_Data_Reports : System.Web.UI.Page
    {
        ...
        protected void BindData()
        {
            try
            {
                ...
                DataTable dt = ProjectRofrBAL.GetMasterDetails.GetBeneficiariesData(district, mandal, village, start, end, (string)(Session["username"]));
                ...
                else
                {
                    ...
                    Response.Redirect("~//test//ROFR_VILLAGE_REPORT.aspx");
                }
            }
            catch (Exception ex)
            {
        ...
        public void BindCount()
        {
            try
            {
                ...
                DataTable dt = ProjectRofrBAL.GetMasterDetails.GetRecordsCount(district, mandal, village, (string)(Session["username"]));
                if (dt.Rows.Count > 0)
                {
