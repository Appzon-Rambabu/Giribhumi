<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Giribhumi_Master.Master" AutoEventWireup="true" CodeBehind="RPayment_Rejected.aspx.cs" Inherits="ROFR.test.RPayment_Rejected" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="panel panel-body" style="margin-top:2px;"> 
         ...
         <div class="row mb-1 mt-1 justify-content-end">
               ...
               <div class="col-md-4"> <h5 class="text-center text-success mb-1 mt-1">RYTHU BHAROSA PAYMENT REJECTED DETAILS</h5></div>
            <div class="col-md-4">
  ...
  <div class="row justify-content-center" style="text-align:right">
   ...
   <div style="text-align:left">
            ...
            <ItemTemplate>
                 <div style="text-align:left">
                 <asp:Label ID="lbl2" ForeColor="Black" Font-Bold="True" Text='<%# Eval("RB_Rejected_Reason") %>' runat="server"  />
           </div>
            </ItemTemplate>
        </asp:TemplateField>
                    </Columns>  
