<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Giribhumi_Master.Master" AutoEventWireup="true" CodeBehind="ForestDivision_Analysis.aspx.cs" Inherits="ROFR.test.ForestDivision_Analysis" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <ItemTemplate>
                <div style="text-align:center">
              <asp:Label  ID="lbl4" runat="server" ForeColor="Black" Font-Bold="True" Text='<%# Eval("FOREST_DIVISION_CODE") %>'></asp:Label>
                    </div>
            </ItemTemplate>
        </asp:TemplateField> 
 ...
 <ItemTemplate>
                <div style="text-align:center">
              <asp:Label  ID="lbl5" runat="server" ForeColor="Black"  Font-Bold="True" Text='<%# Eval("FOREST_DIVISION_NAME") %>'></asp:Label>
                    </div>
            </ItemTemplate>
        </asp:TemplateField> 
