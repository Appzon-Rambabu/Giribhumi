<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/LANDTRANSFER_MASTER.Master" AutoEventWireup="true" CodeBehind="LtrData_Analysis.aspx.cs" EnableEventValidation="false" Inherits="ROFR.test.LtrData_Analysis" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
       <div class="panel-heading" role="tab" id="headingOne" style="margin-top:150px;">
      ...
      <div class="col-md-12 text-left" id="div_field" runat="server">
           <asp:LinkButton ID="btnback" runat="server" ForeColor="MidnightBlue" OnClick="btnback_Click" Font-Underline="true">Back</asp:LinkButton></div>
     <div class="col-md-12 text-right" id="div1" runat="server">
         <asp:ImageButton ID="btnexcel" runat="server" ImageUrl="~/imagesnew/ms-excel.png"  OnClick="btnexcel_Click" />
     </div>
