...
namespace ROFR.test
{
    public partial class ForestDivisionwiseLandDetails : System.Web.UI.Page
    {
        ...
        protected void BindData()
        {
            try
            {
                DataTable dt = Landsettlementpattas.ForestDivisionWiseGetData();
            ...
            try
            {
                ...
                if (start != "Total:")
                {
                    if (start != " ")
                    {
                        if (end == "1")
                        {
                            Session["FDItdavalue"] = start.Trim();
                            Response.Redirect("~//test//ForestRangewiseLandDetails.aspx");
                        }
