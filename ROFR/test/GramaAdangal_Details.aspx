<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Giribhumi_Master.Master" AutoEventWireup="true" CodeBehind="GramaAdangal_Details.aspx.cs" Inherits="ROFR.test.GramaAdangal_Details"  EnableEventValidation="false"%>
      ...
      <div style="margin-top:2px;">
                                <div class="row mb-2">
                                    <div class="col-md-12 d-flex justify-content-between">
                                        <h4 class="text-dark">Details Of Grama Adangal Land Records </h4>
     ...
     <div class="container-fluid">
          <div class="row" style="margin-top:0px;">
            ...
            <ItemTemplate>
                ...
                <asp:Label ID="lbl3"   Text='<%# Eval("SLNO") %>' runat="server" ForeColor="Black" />
  </div>
            </ItemTemplate>
        </asp:TemplateField> 
            ...
            <ItemTemplate>
                 ...
                 <asp:Label ID="lbl9"   Text='<%# Eval("Compartment_No") %>' runat="server" ForeColor="Black" />
                           ...
                           <asp:TemplateField HeaderText="Total Extent" HeaderStyle-ForeColor="Black" HeaderStyle-CssClass="header-center" HeaderStyle-BackColor="White">
            <ItemTemplate>
                  <div style="text-align:left">
                 <asp:Label ID="lbl9"   Text='<%# Eval("TOTAL_EXTENT") %>' runat="server" ForeColor="Black" />
         </div>
            </ItemTemplate>
        </asp:TemplateField> 
            ...
            <ItemTemplate>
                  <div style="text-align:left">
                 <asp:Label ID="lbl9"   Text='<%# Eval("Uncultivable_Land") %>' runat="server" ForeColor="Black" />
         </div>
            </ItemTemplate>
        </asp:TemplateField>
            ...
            <ItemTemplate>
                  <div style="text-align:left">
                 <asp:Label ID="lbl9"  Text='<%# Eval("CULTIVABLE_LAND") %>' runat="server" ForeColor="Black" />
         </div>
            </ItemTemplate>
        </asp:TemplateField>
            ...
            <ItemTemplate>
                  <div style="text-align:left">
                 <asp:Label ID="lbl9"  Text='<%# Eval("HOLDING_NATURE") %>' runat="server" ForeColor="Black" />
         </div>
            </ItemTemplate>
        </asp:TemplateField>
            ...
            <ItemTemplate>
                  <div style="text-align:left">
                 <asp:Label ID="lbl8"   Text='<%# Eval("WATER_SOURCE") %>' runat="server" ForeColor="Black" />
         </div>
            </ItemTemplate>
        </asp:TemplateField>
            ...
            <ItemTemplate>
                  <div style="text-align:left">
                 <asp:Label ID="lbl11"  Text='<%# Eval("extent") %>' runat="server" ForeColor="Black" />
        </div>
            </ItemTemplate>
        </asp:TemplateField>
            ...
            <ItemTemplate>
                  <div style="text-align:left">
                 <asp:Label ID="lbl11"  Text='<%# Eval("REMARKS") %>' runat="server"  ForeColor="Black"/>
        </div>
            </ItemTemplate>
        </asp:TemplateField>
                    </Columns>  
