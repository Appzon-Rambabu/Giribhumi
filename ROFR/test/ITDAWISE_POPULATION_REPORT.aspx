<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Giribhumi_Home.Master" AutoEventWireup="true" CodeBehind="ITDAWISE_POPULATION_REPORT.aspx.cs" Inherits="ROFR.test.ITDAWISE_POPULATION_REPORT" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="row justify-content-center">
     ...
     <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"   
          ...
          <div class="row mb-4">
         <div id="chart_div" style="width:520px;height:400px">
                <%-- Here Chart Will Load --%>
            </div>
           <div id="chart_div1" style="width:520px;height:400px">
                <%-- Here Chart Will Load --%>
            </div>
               </div>
           </div>
