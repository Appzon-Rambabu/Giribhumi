<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/HOME.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="ForestCompartementNumberwiseLand.aspx.cs" Inherits="ROFR.test.ForestCompartementNumberwiseLand" %>
           ...
           <div class="row mb-4">
               ...
               <div class="col-md-2">
                   <div class="row  d-flex justify-content-center" id="Div3" runat="server">
                       <div class="col-md-6 text-center pl-0 pr-0">
                           <asp:Label ID="Label4" runat="server" Text="BEAT:"></asp:Label>
                       </div>

                       <div class="col-md-6 pl-0 pr-0">
                           <asp:Label ID="txtvillage" ForeColor="Red" Font-Bold="True" runat="server"></asp:Label>
    ...
    <div class="row" style="text-align:right">
     ...
     <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"   
            ...
            <ItemTemplate>
              ...
              <asp:Label Class="txt"  ID="lbl1" runat="server"  Font-Bold="True" Text='<%# Eval("sno") %>'></asp:Label>
                    </div>
            </ItemTemplate>
        </asp:TemplateField> 
            ...
            <ItemTemplate>
                <div style="text-align:left">
                      <asp:Label ID="lblc"  Font-Bold="True" Text='<%# Eval("Compartment_No") %>' runat="server" />
                    </div>
            </ItemTemplate>
        </asp:TemplateField>
                        <asp:TemplateField HeaderText="EXTENT (In Acres)" ItemStyle-Width = "150" HeaderStyle-ForeColor="White" HeaderStyle-CssClass="header-center">
            <ItemTemplate>
                 <asp:Label ID="lbl6" ForeColor="#009900" Font-Bold="True" Text='<%# Eval("ExtentPlotArea") %>' runat="server" />
            </ItemTemplate>
        </asp:TemplateField> 
            ...
            <ItemTemplate>
                 <asp:Label ID="lbl7"  Font-Bold="True" Text='<%# Eval("ROFR_PATTADAAR") %>' runat="server" />
                         ...
                         <asp:TemplateField HeaderText="AADHAR NO" ItemStyle-Width = "150" HeaderStyle-ForeColor="White" HeaderStyle-CssClass="header-center">
            <ItemTemplate>
                 <asp:Label ID="lbl8" ForeColor="#009900" Font-Bold="True" Text='<%# Eval("mask") %>' runat="server" />
            </ItemTemplate>
        </asp:TemplateField>    
                    </Columns>  
