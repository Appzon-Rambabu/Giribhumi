            ...
            try
            {
                ...
                if (e.CommandName.Equals("AddNew"))
                {
                    ...
                    if (unique == false)
                    {
                        ...
                        if (!string.IsNullOrEmpty((string)(Session["username"])))
                        {
                            ProjectRofrBAL.GetMasterDetails.InsertForestRange(ddl_district.SelectedValue, mandal, division, FRC.Text.Trim(), FRN.Text.Trim(), IPAddress, (string)(Session["username"]));
