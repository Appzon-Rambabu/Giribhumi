<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Giribhumi_Master.Master" AutoEventWireup="true" CodeBehind="MandalWise_BeneficiaryMaster_Abstract.aspx.cs" Inherits="ROFR.test.MandalWise_BeneficiaryMaster_Abstract"  EnableEventValidation="false"%>
...
<div class="content-area">
      <div class="panel panel-body" style="margin-top:3px;"> 
         ...
         <div class="row mb-1 mt-1 justify-content-end">
               ...
               <div class="col-md-4"> <h5 class="text-center text-success mb-1 mt-1">MANDAL WISE FARMER REPORT</h5></div>
            <div class="col-md-4">
