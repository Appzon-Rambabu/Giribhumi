<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Giribhumi_Master.Master" AutoEventWireup="true" CodeBehind="MandalWise_Rythubarosa.aspx.cs" Inherits="ROFR.test.MandalWise_Rythubarosa" EnableEventValidation="false" %>
    ...
    <div class="content-area">
     <div class="panel panel-body" style="margin-top:2px;"> 
         ...
         <div class="row mb-1 mt-1 justify-content-end">
               ...
               <div class="col-md-4"> <h5 class="text-center text-success mb-1 mt-1">MANDAL WISE RYTHU BHAROSA PAYMENT STATUS</h5></div>
            <div class="col-md-4">
