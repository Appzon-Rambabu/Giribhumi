<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Giribhumi_Home.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="VilagewiseLandDetails.aspx.cs" Inherits="ROFR.test.VilagewiseLandDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <div class="panel panel-body" style="margin-top:2px;"> 
          ...
          <div class="row mb-2">
              <div class="col-md-10">
                  <h5 class="text-center text-success mb-2 mt-3 offset-2">VILLAGE WISE LAND SUMMARY REPORT</h5>
              </div>
              <div class="col-md-2">
           ...
           <div class="row mb-4">
               <div class="col-md-3">
                   <div class="row  d-flex justify-content-center" id="Div1" runat="server">
                       <div class="col-md-6 text-center pl-0 pr-0">
                           <asp:Label ID="txt_Itda" runat="server" Text="ITDA :"></asp:Label>
                       </div>
               ...
               <div class="col-md-3">
                   <div class="row  d-flex justify-content-center" id="Div2" runat="server">
                       <div class="col-md-6 text-center pl-0 pr-0">
                           <asp:Label ID="Label1" runat="server" Text="MANDAL :"></asp:Label>
                       </div>

                       <div class="col-md-6 pl-0 pr-0">
                           <asp:Label ID="txtmandal" ForeColor="Black" Font-Bold="True" runat="server"></asp:Label>
     ...
     <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"   
            ...
            <ItemTemplate>
                <div style="text-align:left">
                    <asp:Label ID="lbl1"  Font-Bold="True" Text='<%# Eval("Village") %>' runat="server" ForeColor="Black"/>
            ...
            <ItemTemplate>
                <div style="text-align:right">
                 <asp:LinkButton ID="LinkButton2" runat="server" Font-Bold="True" ForeColor="Red"  Font-Underline="true"   CommandName="MyUpdate" CommandArgument= '<%#Eval("Village") + "," +Eval("Total_Compartments")%>' CausesValidation="false"   OnClick="link_onclick1" ><%# Eval("Total_Compartments") %></asp:LinkButton>
                 <asp:Label ID="lbl2" ForeColor="#009900" Font-Bold="True" Text='<%# Eval("Total_Compartments") %>' runat="server" Visible="false" />
                    </div>
            </ItemTemplate>
        </asp:TemplateField>
            ...
            <ItemTemplate>
                <div style="text-align:right">
                  <asp:LinkButton ID="LinkButton3" runat="server" Font-Bold="True" ForeColor="Red"  Font-Underline="true"   CommandName="MyUpdate" CommandArgument= '<%#Eval("Village") + "," +Eval("Total_Beneficiaries")%>' CausesValidation="false"   OnClick="link_onclick" ><%# Eval("Total_Beneficiaries") %></asp:LinkButton>
             <asp:Label ID="lbl3"  Font-Bold="True" Text='<%# Eval("Total_Beneficiaries") %>' runat="server"  Visible="false"/>
                    </div>
            </ItemTemplate>
        </asp:TemplateField> 
