<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Giribhumi_Home.Master" AutoEventWireup="true" CodeBehind="MANDALWISE_POPULATION_REPORT.aspx.cs" EnableEventValidation="false" Inherits="ROFR.test.MANDALWISE_POPULATION_REPORT" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="content-area">
      <div class="panel panel-body" style="margin-top:2px;"> 
          ...
          <div class="row mb-2">
              <div class="col-md-10">
                  <h5 class="text-center text-success mb-2 mt-3 offset-2">MANDAL WISE POPULATION REPORT</h5>
              </div>
              <div class="col-md-2">
