<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Giribhumi_Home.Master" AutoEventWireup="true" CodeBehind="VILLAGEWISE_POPULATION_REPORT.aspx.cs" Inherits="ROFR.test.VILLAGEWISE_POPULATION_REPORT" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <div class="panel panel-body" style="margin-top:2px;"> 
          ...
          <div class="row mb-2">
              <div class="col-md-10">
                  <h5 class="text-center text-success mb-2 mt-3 offset-2">VILLAGE WISE POPULATION REPORT</h5>
              </div>
              <div class="col-md-2">
     ...
     <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"   
            ...
            <ItemTemplate>
                <div style="text-align:left">
                    <asp:Label ID="lbl1"  Font-Bold="True" Text='<%# Eval("Village") %>' runat="server"  ForeColor="red"/>
            ...
            <ItemTemplate>
                 ...
                 <asp:Label ID="lbl2" ForeColor="Green" Font-Bold="True" Text='<%# Eval("ST_POPULATION") %>' runat="server" />
                     </div>
            </ItemTemplate>
        </asp:TemplateField> 
            ...
            <ItemTemplate>
                 ...
                 <asp:Label ID="lbl3"  Font-Bold="True" Text='<%# Eval("Total_Beneficiaries") %>' runat="server" />
                         ...
                         <asp:TemplateField HeaderText="Farmers covered in PSS"  HeaderStyle-ForeColor="White" HeaderStyle-CssClass="header-center">
            <ItemTemplate>
                 <div style="text-align:right">
                 <asp:Label ID="lbl4" ForeColor="Green" Font-Bold="True" Text='<%# Eval("Beneficiaries_Surveyed_PSS") %>' runat="server" />
           </div>
                      </ItemTemplate>
        </asp:TemplateField>   
                         <asp:TemplateField HeaderText="Farmers not covered in PSS"  HeaderStyle-ForeColor="White" HeaderStyle-CssClass="header-center">
            <ItemTemplate>
                 <div style="text-align:right">
                 <asp:Label ID="lbl5"  Font-Bold="True" Text='<%# Eval("Beneficiaries_not_Surveyed_PSS") %>' runat="server" />
                          ...
                          <asp:TemplateField HeaderText="Total Distributed Land(In Acres)"  HeaderStyle-ForeColor="White" HeaderStyle-CssClass="header-center">
            <ItemTemplate>
                 <div style="text-align:right">
                 <asp:Label ID="lbl6" ForeColor="Green" Font-Bold="True" Text='<%# Eval("Total_Land") %>' runat="server" />
                     </div>
            </ItemTemplate>
        </asp:TemplateField>     
                    </Columns>  
