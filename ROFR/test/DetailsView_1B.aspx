<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Giribhumi_Master.Master" AutoEventWireup="true" CodeBehind="DetailsView_1B.aspx.cs" Inherits="ROFR.test.DetailsView_1B" %>
          ...
          <div style="margin-top:1px;">
                                <div class="row mb-2">
                                    <div class="col-md-12 d-flex justify-content-between">
                                        <h4 class="text-dark">Details Of Land Records 1B Namuna</h4>
