<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Giribhumi_Master.Master" AutoEventWireup="true" CodeBehind="ViewFarmer_Details.aspx.cs" Inherits="ROFR.test.ViewFarmer_Details"  EnableEventValidation="false"%>
     ...
     <%--     <asp:ListItem Selected="True" Value="A">Compartment No.&nbsp</asp:ListItem>--%>
         <%-- <asp:ListItem Value="B">Patta No.&nbsp&nbsp</asp:ListItem>--%>
          ...
          <asp:ListItem Value="D">Pattadar Name</asp:ListItem>
            ...
            <ItemTemplate>
                  <div style="text-align:left">
                 <asp:Label ID="lbl3" ForeColor="#009900" Font-Bold="True" Text='<%# Eval("Father_Name") %>' runat="server" />
            </div>
                      </ItemTemplate>
        </asp:TemplateField> 
