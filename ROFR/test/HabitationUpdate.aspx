<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Giribhumi_Master.Master" AutoEventWireup="true" CodeBehind="HabitationUpdate.aspx.cs" Inherits="ROFR.test.HabitationUpdate"  EnableEventValidation="false"%>
...
.headertable .aftr th{position: sticky;top: 49x;}
      ...
      <script type="text/javascript">
        function deleteConfirm(pubid) {
            var result = confirm('Do you want to delete Habitation ?');
            if (result) {
                return true;
            }
            else {
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="content-area">
     <div class="panel panel-body" style="margin-top:2px;">
        ...
        <h5 class="text-center text-success">UPDATE FOREST HABITATION WITH REVENUE</h5>
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-1 text-right">
                <asp:Label ID="Label15" runat="server" Text="Habitation:" Visible="false"></asp:Label>&nbsp<asp:Label ID="Label16" runat="server" Text="*" ForeColor="Red" Visible="false"></asp:Label>
            </div>
            <div class="col-md-2">
                <asp:DropDownList ID="ddl_Hab" Style="width: 150px" AutoPostBack="true" OnSelectedIndexChanged="ddlhab_OnSelectedIndexChanged" runat="server" Visible="false"></asp:DropDownList>
            </div>
      ...
      onrowcommand="gridView_RowCommand"
        OnRowDataBound="gridView_RowDataBound">
                                    <Columns>
                                        <asp:TemplateField HeaderText="Sno" HeaderStyle-ForeColor="White" ItemStyle-Width="190">
                                            <ItemTemplate>
                                                <asp:Label ID="lbl_divisioncode0" runat="server" ForeColor="Black" Text='<%# Eval("Sno") %>'></asp:Label>

                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="HABITATION NAME" HeaderStyle-ForeColor="White" ItemStyle-Width="190">
                                            <ItemTemplate>
                                                <asp:Label ID="lbl_divisioncode" runat="server" ForeColor="Black" Text='<%# Eval("HAB_NAME") %>'></asp:Label>

                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txt_divisioncode" runat="server" Text='<%# Eval("HAB_NAME") %>' onkeypress='mastervalidatenumerics(event)' Width="180"></asp:TextBox>
                                            </EditItemTemplate>
                                            <FooterTemplate>
                                                <asp:TextBox ID="instorid" Width="120px" runat="server" onkeypress='mastervalidatenumerics(event)' />
                                ...
                                <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False"
                                    BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" ShowFooter="true"
                                    CellPadding="4" DataKeyNames="HAB_NAME"
                                  onrowcommand="gridView_RowCommand">
                                    <Columns>
                                        <asp:TemplateField HeaderText="HABITATION NAME" HeaderStyle-ForeColor="White" ItemStyle-Width="190">
                                            <ItemTemplate>
                                             <asp:Label ID="lbl_divisioncode" ForeColor="Black" runat="server" Text='<%# Eval("HAB_NAME") %>'></asp:Label>
