<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Giribhumi_Master.Master" AutoEventWireup="true" CodeBehind="ForestRange_Analysis.aspx.cs" Inherits="ROFR.test.ForestRange_Analysis" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
 ...
 <ItemTemplate>
                <div style="text-align:center">
              <asp:Label  ID="lbl7" runat="server" ForeColor="Black"  Font-Bold="True" Text='<%# Eval("FOREST_DIVISION_CODE") %>'></asp:Label>
                    </div>
            </ItemTemplate>
        </asp:TemplateField> 
 ...
 <ItemTemplate>
                <div style="text-align:center">
              <asp:Label  ID="lbl8" runat="server"  ForeColor="Black" Font-Bold="True" Text='<%# Eval("FOREST_DIVISION_NAME") %>'></asp:Label>
                    </div>
            </ItemTemplate>
        </asp:TemplateField> 
 ...
 <ItemTemplate>
                <div style="text-align:center">
              <asp:Label  ID="lbl9" runat="server" ForeColor="Black"  Font-Bold="True" Text='<%# Eval("FOREST_RANGE_CODE") %>'></asp:Label>
                    </div>
            </ItemTemplate>
        </asp:TemplateField> 
 ...
 <ItemTemplate>
                <div style="text-align:center">
              <asp:Label  ID="lbl10" runat="server" ForeColor="Black"  Font-Bold="True" Text='<%# Eval("FOREST_RANGE_NAME") %>'></asp:Label>
                    </div>
            </ItemTemplate>
        </asp:TemplateField> 
