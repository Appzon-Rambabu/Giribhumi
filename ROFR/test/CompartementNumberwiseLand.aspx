<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Giribhumi_Home.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="CompartementNumberwiseLand.aspx.cs" Inherits="ROFR.test.CompartementNumberwiseLand" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="content-area">
      <div class="panel panel-body" style="margin-top:2px;"> 
          ...
          <div class="row mb-2">
              <div class="col-md-10">
                  <h5 class="text-center text-success mb-2 mt-3 offset-2">COMPARTEMENT NO WISE LAND SUMMARY REPORT</h5>
              </div>
              <div class="col-md-2">
           ...
           <div class="row mb-4">
               ...
               <div class="col-md-2">
                   <div class="row  d-flex justify-content-center" id="Div3" runat="server">
                       ...
                       <div class="col-md-6 pl-0 pr-0">
                           <asp:Label ID="txtvillage" ForeColor="Black" Font-Bold="True" runat="server"></asp:Label>
    ...
    <div class="row justify-content-center">
     ...
     <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False"   
            ...
            <ItemTemplate>
              ...
              <asp:Label Class="txt"  ID="lbl1" runat="server"  Font-Bold="True" Text='<%# Eval("sno") %>' ForeColor="Black"></asp:Label>
                    </div>
            </ItemTemplate>
        </asp:TemplateField> 
            ...
            <ItemTemplate>
                <div style="text-align:left">
                 <asp:Label ID="lbl7"  Font-Bold="True" Text='<%# Eval("ROFR_PATTADAAR") %>' runat="server" ForeColor="Black"/>
                    </div>
            </ItemTemplate>
        </asp:TemplateField>
            ...
            <ItemTemplate>
                <div style="text-align:right">
                      <asp:Label ID="lblc"  Font-Bold="True" Text='<%# Eval("Compartment_No") %>' runat="server" ForeColor="Black" />
                    </div>
            </ItemTemplate>
        </asp:TemplateField>
                     
                        <asp:TemplateField HeaderText="EXTENT (In Acres)"  HeaderStyle-ForeColor="White" HeaderStyle-CssClass="header-center">
            <ItemTemplate>
                <div style="text-align:right">
                 <asp:Label ID="lbl6" ForeColor="Black" Font-Bold="True" Text='<%# Eval("ExtentPlotArea") %>' runat="server" />
                     </div>
            </ItemTemplate>
        </asp:TemplateField> 
            ...
            <ItemTemplate>
                 <div style="text-align:right">
                 <asp:Label ID="lbl8" ForeColor="Black" Font-Bold="True" Text='<%# Eval("mask") %>' runat="server" />
                 </div>
            </ItemTemplate>
        </asp:TemplateField>    
                    </Columns>  
