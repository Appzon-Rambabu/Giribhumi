<%@ Page Title="" Language="C#" MasterPageFile="~/Masters/Giribhumi_Master.Master" AutoEventWireup="true" CodeBehind="View_FarmerPlots.aspx.cs" Inherits="ROFR.test.View_FarmerPlots"  EnableEventValidation="false"%>
          ...
          <div class="row" style="margin-top:0px;">
            ...
            <ItemTemplate>
                <div style="text-align:center">
                    ...
                    <asp:Label ID="lbl1" Text='<%# Eval("benficiary_id2") %>'  runat="server" ForeColor="Black" />
                    </div>
            </ItemTemplate>
        </asp:TemplateField>
